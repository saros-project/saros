...
public final class UserColorID implements Serializable {
     ...
     * 
     * @param current
     *            the value to use for the current color id
     * @param favorite
     *            the value to use for the favorite color id
     */
     ...
     * 
     * @param colorID
     *            the new favorite color id to set
     */
