...
public class SessionDataCollector extends AbstractStatisticCollector {
     ...
     * can be used to track the randomly generated {@link
     * StatisticManager##getUserID()} to a "real" person if the user chooses to
     * do so.
     * 
     * @since 9.9.11
     */
    ...
    protected void processGatheredData() {
        ...
        data.put(
            ...
            StatisticManager.getTimeInMinutes(Math.max(0,
                localSessionEnd.getTime() - localSessionStart.getTime())));
