...
/**
 * The SessionStatistic class wraps a <code>Properties</code> object in which
 * the gathered statistical data can be stored as simple key/value pairs. This
 * data can then be saved to disk as a file.
 * <p>
 * This class offers various <code>put</code> methods which optionally take
 * suffixes to add to the end of the key.
 * <p>
 ...
 * <code>foo.bar.1.enabled</code>, <code>foo.bar.2.enabled</code>, and so on ...
 * <p>
 */
/*
