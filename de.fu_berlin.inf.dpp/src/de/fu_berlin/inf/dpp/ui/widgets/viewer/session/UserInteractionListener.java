...
public class UserInteractionListener extends MouseAdapter {
    ...
    /**
     * Tries to find a tree item at the given click coordinates. If it doesn't
     * find anything, it continuously tries to find a target by shifting the X
     * coordinate.
     * 
     * @param event
     * @return
     ...
     * 
     * Jump to User file+position when doubleclicked on AwarenessTreeItem.
     * 
     */
    @Override
