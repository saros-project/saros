 ...
 *
 * <p>The composite's content is surrounded by a rounded rectangle if a background is set.
 *
 * <dl>
 *   <dt><b>Styles:</b>
 *   <dd>SEPARATOR, and those supported by Composite excluding NO_BACKGROUND
 *   <dt><b>Events:</b>
 *   <dd>(none)
 * </dl>
 *
 * <p>Note: If you use SEPARATOR the content gets right aligned and the generated space filled with
 * a small horizontal line.
 *
 * <p>This class may be subclassed by custom control implementors who are building controls that are
...
public class RoundedComposite extends Canvas {
  ...
  /**
   * Scale by which the background color's lightness should be modified for use as the border color.
   */
  ...
  private void createBorder() {
    ...
    border = ColorUtils.scaleColorBy(backgroundColor, BORDER_LIGHTNESS_SCALE);
  }
