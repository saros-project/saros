...
public class ContactSelectionComposite extends
    ...
    protected final ICheckStateListener checkStateListener = new ICheckStateListener() {
        @Override
        public void checkStateChanged(CheckStateChangedEvent event) {
            ...
            if (jid != null)
                notifyContactSelectionChanged(jid, event.getChecked());
        }
    };
    ...
    public List<JID> getSelectedContactsWithSarosSupport() {
        ...
        for (Object element : getViewer().getCheckedElements()) {
            ...
            if (contact != null && isSarosSupported)
                contacts.add(contact);
        }
        return contacts;
    }
    ...
    public void notifyContactSelectionChanged(JID jid, boolean isSelected) {
        ContactSelectionChangedEvent event = new ContactSelectionChangedEvent(
            jid, isSelected);
