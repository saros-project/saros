...
public class LayoutUtils {
    ...
    public static GridLayout createGridLayout(int numColumns,
        boolean makeColumnsEqualWidth, int marginWidth, int marginHeight,
     ...
     * @param makeColumnsEqualWidth
     * @param margin
     *            used for marginWidth and marginHheight
     * @param spacing
     *            used horizontalSpacing and verticalSpacing
     * @return
     */
    public static GridLayout createGridLayout(int numColumns,
        boolean makeColumnsEqualWidth, int margin, int spacing) {
        return createGridLayout(numColumns, makeColumnsEqualWidth, margin,
