 ...
 */
public class UPnPAccessWeupnp implements IUPnPAccess {
    ...
    public int addPortMapping(GatewayDevice gateway, int externalPort,
        ...
        return gateway.addPortMapping(externalPort, internalPort,
            internalClient, protocol, description, leaseDuration);
    }
