...
public interface IUPnPAccess {
    ...
    /**
     * Deletes the specified port mapping associated with the external port and
     * the protocol.
     * 
     * @param gateway
     *            A UPnP-compliant gateway device using the mapping.
     * @param port
     *            The external port
     * @param protocol
     *            The protocol
     ...
     * 
     * @param gateway
     *            The gateway device receiving the new mapping.
     * 
     * @param externalPort
     *            The external port associated with the new mapping
     * @param internalPort
     ...
     * @param description
     *            A description to accompany the mapping
     * @param leaseDuration
     *            amount of seconds this mapping is valid. Use 0 for unlimited
     *            duration.
     * @return Error code. 0 if successful.
     * @throws IOException
     * @throws SAXException
