...
public class EclipseFolderImpl extends EclipseAbstractFolderImpl implements IFolder {

  public EclipseFolderImpl(org.eclipse.core.resources.IFolder delegate) {
    super(delegate);
  }
