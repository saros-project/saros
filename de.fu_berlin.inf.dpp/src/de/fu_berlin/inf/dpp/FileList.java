...
public class FileList {
     ...
     * 
     * @param container the resource container that should be represented by the
     * new file list.
     * @throws CoreException exception that might happen while fetching the
     * files from the given container.
     */
     ...
     * @param container the resource container that should be represented by the
     * new file list.
     * @param ignoreDerived <code>true</code> if derived resources should be
     * ignored.
     * @throws CoreException exception that might happen while fetching the
     * files from the given container.
     */
    ...
    public boolean equals(Object obj) {
        ...
        return all.equals(other.all) && added.equals(other.added) && 
            removed.equals(other.removed) && altered.equals(other.altered) && 
            unaltered.equals(other.unaltered);
    }
    ...
    private void addMembers(IResource[] resources, Map<IPath, Long> members, 
        ...
        for (int i = 0; i < resources.length; i++) {
            ...
            if (resources[i] instanceof IFile) {
                ...
                members.put(file.getProjectRelativePath(), checksum(file));
