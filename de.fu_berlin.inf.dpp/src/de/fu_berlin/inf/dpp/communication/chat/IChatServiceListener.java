...
/**
 * This listener is invoked with notifications related to an {@link IChat}s life
 * cycle.
 */
public interface IChatServiceListener {
    ...
    /**
     * Gets called whenever an {@link IChat} has been aborted through errors in
     * the XMPP/network layer.
     * 
     * @param chat
