...
public interface ISessionListener {
	 ...
	 * 
	 * @param session the shared project that has been created. Is never
	 * <code>null</code>.
	 * 
	 */
    ...
    /**
     * Is fired when a session ended. Reasons for this can be that the
     * session was closed or that the user left by himself.
     * 
     * @param session the shared project that has just been left. Is never 
     * <code>null</code>. 
     */
     ...
     * 
     * @param process the invitation process which represents the invitation.
     */
