...
/**
 * A StopActivityDataObject is used for signaling to a user that he should be stopped or
 * started (meaning that no more activityDataObjects should be generated by this user).
 */
...
public class StopActivityDataObject extends AbstractActivityDataObject {
    ...
    public StopActivityDataObject(JID source, JID initiator, JID user, Type type,
        State state) {
    ...
    /**
     * Returns the JID of the user to which this StopActivityDataObject should be sent.
     * 
