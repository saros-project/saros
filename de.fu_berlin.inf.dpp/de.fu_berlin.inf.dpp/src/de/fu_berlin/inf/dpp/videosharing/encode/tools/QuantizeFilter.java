...
public class QuantizeFilter extends WholeImageFilter {
     ...
     */
    protected final static int[] matrix = { 0, 0, 0, 0, 0, 7, 3, 5, 1, };
    ...
    public void setNumColors(int numColors) {
        this.numColors = Math.max(numColors, 8);
    }
    ...
    public void quantize(int[] inPixels, int[] outPixels, int width,
        int height, int numColors, boolean dither, boolean serpentine) {
