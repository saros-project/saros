...
public class ShareFilesToProjectsWithDifferentEncoding extends StfTestCase {
    ...
    public void testShareFilesWithDifferentProjectEncodingsAndRecovery()
        ...
        assertEquals(CONTENT, ALICE.remoteBot().editor("Herr Mannelig.txt")
            .getText());
    ...
    private void createProjects(String aliceCharset, String bobCharset)
        ...
        ALICE.superBot().internal()
            .createFile("foo", "Herr Mannelig.txt", CONTENT);
