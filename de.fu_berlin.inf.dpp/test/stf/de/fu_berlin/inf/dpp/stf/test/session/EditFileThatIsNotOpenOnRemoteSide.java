...
public class EditFileThatIsNotOpenOnRemoteSide extends StfTestCase {
    ...
    public void testEditFileThatIsNotOpenOnRemoteSide() throws Exception {
        ...
        for (int i = 0; i < 10; i++)
            builder
                .append("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa\n");
        ...
        BOB.superBot().views().packageExplorerView()
            .waitUntilResourceIsShared("foo/text.txt");
        ...
        for (int i = 0; i < 20; i++) {
            ...
            assertTrue("text corrupted: '" + text
