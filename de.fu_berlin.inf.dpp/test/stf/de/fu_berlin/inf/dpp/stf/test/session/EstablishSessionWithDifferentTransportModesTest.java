 ...
 */
public class EstablishSessionWithDifferentTransportModesTest extends
    StfTestCase {
    ...
    private void simulateSession() throws Exception {
        ...
        assertEquals(BOB.remoteBot().editor("bar.txt").getText(), ALICE
            .remoteBot().editor("bar.txt").getText());
    }
