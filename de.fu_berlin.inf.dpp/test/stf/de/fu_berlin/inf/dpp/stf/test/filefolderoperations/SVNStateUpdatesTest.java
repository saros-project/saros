...
public class SVNStateUpdatesTest extends StfTestCase {
    ...
    // * <li>Alice and Bob both have the project which is checked out from
    // SVN:<br>
    ...
    // .tree()
    // .existsWithRegex(
    // ".*" + Pattern.quote(Constants.SVN_PROJECT) + ".*"));
    // tester.remoteBot().sleep(60000);
    // assertTrue(tester.superBot().views().packageExplorerView()
    // .isProjectManagedBySVN(Constants.SVN_PROJECT));
    // assertTrue(tester.superBot().views().packageExplorerView()
    // .selectPkgWithRegex(".*stf_test_project.*", "pkg")
    ...
    // .views()
    // .packageExplorerView()
    // .selectClassWithRegex(Pattern.quote(Constants.SVN_PROJECT) + ".*",
    // Pattern.quote(Constants.SVN_PKG),
    // Pattern.quote(Constants.SVN_CLS1)).refactor().rename("Asdf");
    //
    // assertTrue(ALICE
    // .superBot()
    // .views()
    // .packageExplorerView()
    // .selectPkgWithRegex(Pattern.quote(Constants.SVN_PROJECT) + ".*",
    // Pattern.quote(Constants.SVN_PKG)).existsWithRegex("Asdf.java"));
    // }
    //
    // /**
    // * Steps:
    ...
    // * <li>Bob moves the file {@link Constants#SVN_CLS1} to
    // "new_package".</li>
    // * </ol>
    // * Result:
    // * <ol>
    ...
    // * Result:
    // * <ol>
    // * <li>Bob's copy of SVN_PROJECT gets switched to
    // SVN_PROJECT_URL_SWITCHED.</li>
    // * </ol>
    // *
    // * @throws RemoteException
    // */
    ...
    // * Steps:
    // * <ol>
    // * <li>Alice updates the entire project to the older revision Y (<
    // HEAD)..</li>
    // * </ol>
    // * Result:
    // * <ol>
    ...
    // * Steps:
    // * <ol>
    // * <li>Alice updates the file Main.java to the older revision Y (<
    // HEAD)</li>
    // * </ol>
    // * Result:
    // * <ol>
