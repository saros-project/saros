...
public class NonUISynchronizerTest {
    ...
    public void testIsDispatchThread() {
        ...
        assertTrue("isDispatchThread method should return true",
            isDispatchThread.get());

        assertFalse("isDispatchThread method should return false",
            synchronizer.isUIThread());
    }
