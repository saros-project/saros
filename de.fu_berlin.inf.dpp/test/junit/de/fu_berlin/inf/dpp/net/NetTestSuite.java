...
@Suite.SuiteClasses({ FileListTest.class, GZipTest.class, JIDTest.class,
    ...
    RosterAdapterTest.class, TimedActivityDataObjectTest.class,
    XMPPUtilTest.class, InternalTestSuite.class, JingleProtocolTestSuite.class,
    NetUtilTestSuite.class })
