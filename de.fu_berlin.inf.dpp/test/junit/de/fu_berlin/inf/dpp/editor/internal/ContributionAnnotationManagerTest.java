...
public class ContributionAnnotationManagerTest {
  ...
  public void testHistoryRemoval() {
    ...
    User alice = new User(new JID("alice@test"), false, false, false, 0, 0);
  ...
  public void testAnnotationSplit() {
    ...
    final User alice = new User(new JID("alice@test"), false, false, false, 0, 0);
    final User bob = new User(new JID("bob@test"), false, false, false, 0, 0);
