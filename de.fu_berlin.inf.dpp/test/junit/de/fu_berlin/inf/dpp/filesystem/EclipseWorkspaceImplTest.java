...
public class EclipseWorkspaceImplTest {
    ...
    public void setup() {
        ...
        workspaceDelegateMock = EasyMock
            .createMock(org.eclipse.core.resources.IWorkspace.class);

        try {
            workspaceDelegateMock
                .run(
                    EasyMock
                        .isA(org.eclipse.core.resources.IWorkspaceRunnable.class),
                    EasyMock
                        .anyObject(org.eclipse.core.runtime.jobs.ISchedulingRule.class),
                    EasyMock.anyInt(),
                    EasyMock
                        .anyObject(org.eclipse.core.runtime.IProgressMonitor.class));
        ...
        EasyMock.expectLastCall().andStubAnswer(new IAnswer<Object>() {
            ...
            public Object answer() throws Throwable {
                ((org.eclipse.core.resources.IWorkspaceRunnable) EasyMock
                    .getCurrentArguments()[0])
                    .run((org.eclipse.core.runtime.IProgressMonitor) EasyMock
                        .getCurrentArguments()[3]);
                return null;
            }
        });
    ...
    private void assertOriginalExceptionNotSwallowed(Exception e,
        String methodName) {
        assertTrue("method name '" + methodName + "'not found in stack trace",
