...
public interface Constants {
    ...
    public static final String PROJECT_PARTIAL_SHARED_DECORATOR = get("SharedProjectDecorator_shared_partial");
    ...
    public static final String LABEL_ENTER_OR_SELECT_THE_PARENT_FOLDER = "Enter or select the parent folder:";
    ...
    public static final String SHELL_CREATE_XMPP_JABBER_ACCOUNT = get("shell_create_xmpp_jabber_account");
    ...
    public static final String ResourceSelectionComposite_delete_dialog_title = get("ResourceSelectionComposite_delete_dialog_title");
    public static final String ResourceSelectionComposite_overwrite_dialog_title = get("ResourceSelectionComposite_overwrite_dialog_title");
    ...
    public static final String BUTTON_ACTIVATE_ACCOUNT = get("button_text_activate_account_in_shell-saros-preferences");
    public static final String BUTTON_EDIT_ACCOUNT = get("button_edit_account");
    public static final String BUTTON_ADD_ACCOUNT = get("button_text_add_account_in_shell-saros-preferences");
    public static final String BUTTON_REMOVE_ACCOUNT = get("GeneralPreferencePage_REMOVE_BTN_TEXT");
    public static final String CHECKBOX_AUTO_CONNECT_ON_STARTUP = get("checkbox_label_auto_connect_on_startup_in_shell-saros-preferences");
    ...
    public static final String PREF_NODE_SAROS_NETWORK_TRANSPORT_MODE_IBB_CHECKBOX = get("NetworkPreferencePage_button_establish_connection");
    public static final String PREF_NODE_SAROS_NETWORK_ADVANCED_GROUP_FILE_TRANSFER = get("saros_advanced_group_file_transfer");
    public static final String PREF_NODE_SAROS_NETWORK_ADVANCED_GROUP_FILE_TRANSFER_FORCE_IBB = get("saros_advanced_group_file_transfer_force_ibb");
    ...
    public static final String SHELL_REQUEST_OF_SUBSCRIPTION_RECEIVED = get("SubscriptionManager_incoming_subscription_request_title");
    public static final String SHELL_SERVER_NOT_FOUND = get("shell_server_not_found");
    public static final String SHELL_SET_NEW_NICKNAME = get("RenameContactAction_new_nickname_dialog_title");
    ...
    public static final String SHELL_CONFIRM_SAVE_UNCHANGED_CHANGES = get("AddProjectToSessionWizard_unsaved_changes_dialog_title");
    ...
    public static final String SHELL_MONITOR_PROJECT_SYNCHRONIZATION = get("shell_monitor_project_synchronization");
    /* *********************************************
     * 
     * Others
     * 
