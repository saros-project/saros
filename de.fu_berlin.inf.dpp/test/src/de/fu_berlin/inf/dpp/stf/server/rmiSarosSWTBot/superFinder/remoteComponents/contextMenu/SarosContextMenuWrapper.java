...
public interface SarosContextMenuWrapper extends Remote {
    ...
    /**
     * wait until the condition {@link SarosContextMenuWrapper#hasWriteAccess()}
     * is true . This method should be used after performing the action
     * {@link SarosContextMenuWrapper#grantWriteAccess()} to guarantee the
     ...
     * {@link SarosContextMenuWrapper#hasReadOnlyAccess()} is true. This method
     * should be used after performing the action
     * {@link SarosContextMenuWrapper#restrictToReadOnlyAccess()} or
     * {@link SessionView#restrictInviteesToReadOnlyAccess()} to guarantee
     ...
     * {@link SarosContextMenuWrapper#isFollowingThisBuddy()} is true.
     * 
     * @throws RemoteException
     */
    ...
    /**
     * Wait until the condition
     * {@link SarosContextMenuWrapper#isFollowingThisBuddy()} is false.
     * 
     * @throws RemoteException
     */
