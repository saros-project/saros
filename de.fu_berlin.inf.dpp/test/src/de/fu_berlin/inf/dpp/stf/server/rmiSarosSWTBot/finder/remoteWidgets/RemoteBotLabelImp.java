...
public class RemoteBotLabelImp extends AbstractRmoteWidget implements RemoteBotLabel {

    private static transient RemoteBotLabelImp self;
     ...
     */
    public static RemoteBotLabelImp getInstance() {
        if (self != null)
            return self;
        self = new RemoteBotLabelImp();
        return self;
    }

    public RemoteBotLabel setWidget(SWTBotLabel label) {
        this.widget = label;
        return this;
    }
