...
public class RemoteBotTreeImp extends AbstractRmoteWidget implements RemoteBotTree {

    private static transient RemoteBotTreeImp self;
     ...
     */
    public static RemoteBotTreeImp getInstance() {
        if (self != null)
            return self;
        self = new RemoteBotTreeImp();
        return self;
    }

    public RemoteBotTree setWidget(SWTBotTree tree) {
        widget = tree;
        return this;
    }
    ...
    public RemoteBotTreeItem[] getAllItems() throws RemoteException {
        RemoteBotTreeItem[] items = new RemoteBotTreeItem[widget.getAllItems().length];
    ...
    public RemoteBotTreeItem selectTreeItem(String... pathToTreeItem)
        throws RemoteException {
    ...
    public RemoteBotTreeItem selectTreeItemAndWait(String... pathToTreeItem)
        throws RemoteException {
        ...
        for (String node : pathToTreeItem) {
            try {
                if (selectedTreeItem == null) {
                    ...
                    RemoteBotTreeItemImp treeItem = RemoteBotTreeItemImp
                        .getInstance();
