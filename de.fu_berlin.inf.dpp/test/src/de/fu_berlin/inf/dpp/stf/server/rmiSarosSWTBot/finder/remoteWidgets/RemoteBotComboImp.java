...
public class RemoteBotComboImp extends AbstractRmoteWidget implements RemoteBotCombo {

    private static transient RemoteBotComboImp self;

    private SWTBotCombo widget;

    /**
     * {@link RemoteBotComboImp} is a singleton, but inheritance is possible.
     */
    public static RemoteBotComboImp getInstance() {
        if (self != null)
            return self;
        self = new RemoteBotComboImp();
        return self;
    }

    public RemoteBotCombo setWidget(SWTBotCombo ccomb) {
        this.widget = ccomb;
        return this;
    }
