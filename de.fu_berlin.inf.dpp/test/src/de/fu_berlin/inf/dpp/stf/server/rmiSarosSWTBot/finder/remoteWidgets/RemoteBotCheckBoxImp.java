...
public class RemoteBotCheckBoxImp extends AbstractRmoteWidget implements
    RemoteBotCheckBox {

    private static transient RemoteBotCheckBoxImp self;

    private SWTBotCheckBox widget;

    /**
     * {@link RemoteBotCheckBoxImp} is a singleton, but inheritance is possible.
     */
    public static RemoteBotCheckBoxImp getInstance() {
        if (self != null)
            return self;
        self = new RemoteBotCheckBoxImp();
        return self;
    }

    public RemoteBotCheckBox setWidget(SWTBotCheckBox checkBox) {
