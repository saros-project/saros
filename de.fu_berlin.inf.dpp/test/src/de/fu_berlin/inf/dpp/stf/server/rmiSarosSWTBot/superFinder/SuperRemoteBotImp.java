...
public class SuperRemoteBotImp extends STF implements SuperRemoteBot {

    private static transient SuperRemoteBotImp self;

    private static RemoteWorkbenchBot bot;
    ...
    /**
     * {@link SuperRemoteBotImp} is a singleton, but inheritance is possible.
     */
    public static SuperRemoteBotImp getInstance() {
        if (self != null)
            return self;
        self = new SuperRemoteBotImp();
        bot = RemoteWorkbenchBotImp.getInstance();
    ...
    public void confirmShellAddProjectWithNewProject(String projectname)
        ...
        RemoteBotShell shell = bot().shell(SHELL_ADD_PROJECT);
        shell.activate();
    ...
    public void confirmShellEditXMPPJabberAccount(String xmppJabberID,
        ...
        RemoteBotShell shell = bot().shell(SHELL_EDIT_XMPP_JABBER_ACCOUNT);
        shell.activate();
    ...
    public void confirmShellAddXMPPJabberAccount(JID jid, String password)
        ...
        RemoteBotShell shell = bot().shell(SHELL_ADD_XMPP_JABBER_ACCOUNT);
        shell.activate();
        /*
    ...
    public void confirmShellAddBuddyToSession(String... baseJIDOfinvitees)
        ...
        RemoteBotShell shell = bot().shell(SHELL_ADD_BUDDY_TO_SESSION);
        shell.activate();
