...
public class RemoteBotTableItemImp extends AbstractRmoteWidget implements
    RemoteBotTableItem {

    private static transient RemoteBotTableItemImp self;

    private SWTBotTableItem widget;

    /**
     * {@link RemoteBotTableItemImp} is a singleton, but inheritance is possible.
     */
    public static RemoteBotTableItemImp getInstance() {
        if (self != null)
            return self;
        self = new RemoteBotTableItemImp();
        return self;
    }

    public RemoteBotTableItem setWidget(SWTBotTableItem tableItem) {
