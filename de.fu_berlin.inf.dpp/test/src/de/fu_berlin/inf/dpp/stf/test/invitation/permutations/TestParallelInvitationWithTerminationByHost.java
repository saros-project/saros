...
public class TestParallelInvitationWithTerminationByHost {
    ...
    public void testExistDirtyFlagByDaveAndEdnaDuringAlicMakeChange()
        ...
        alice.bot.cancelInvitation(bob.jid, dave.jid, carl.jid);
        ...
        alice.bot.cancelInvitation(carl.jid, bob.jid, dave.jid);
        ...
        alice.bot.cancelInvitation(dave.jid, bob.jid, carl.jid);
