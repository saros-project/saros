...
public class RemoteBotListImp extends AbstractRmoteWidget implements RemoteBotList {

    private static transient RemoteBotListImp listImp;

    private SWTBotList widget;

    /**
     * {@link RemoteBotListImp} is a singleton, but inheritance is possible.
     */
    public static RemoteBotListImp getInstance() {
        if (listImp != null)
            return listImp;
        listImp = new RemoteBotListImp();
        return listImp;
    }

    public RemoteBotList setWidget(SWTBotList list) {
        this.widget = list;
        return this;
    }
