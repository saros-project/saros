...
public class RemoteBotShellImp extends AbstractRmoteWidget implements RemoteBotShell {
    private static transient RemoteBotShellImp self;
     ...
     */
    public static RemoteBotShellImp getInstance() {
        if (self != null)
            return self;
        self = new RemoteBotShellImp();
        return self;
    }

    public RemoteBotShell setWidget(SWTBotShell shell) {
        this.widget = shell;
        return this;
    }
    ...
    public RemoteBot bot() {
        RemoteBotImp botImp = RemoteBotImp.getInstance();
