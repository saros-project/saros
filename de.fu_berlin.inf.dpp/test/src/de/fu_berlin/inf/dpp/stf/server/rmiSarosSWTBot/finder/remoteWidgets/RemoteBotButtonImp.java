...
public class RemoteBotButtonImp extends AbstractRmoteWidget implements
    RemoteBotButton {

    private static transient RemoteBotButtonImp self;
     ...
     */
    public static RemoteBotButtonImp getInstance() {
        if (self != null)
            return self;
        self = new RemoteBotButtonImp();
        return self;
    }

    public RemoteBotButton setWidget(SWTBotButton button) {
        this.widget = button;
        return this;
    }
