...
public class RemoteBotEditorImp extends AbstractRmoteWidget implements
    RemoteBotEditor {

    private static transient RemoteBotEditorImp self;

    private SWTBotEclipseEditor widget;

    /**
     * {@link RemoteBotEditorImp} is a singleton, but inheritance is possible.
     */
    public static RemoteBotEditorImp getInstance() {
        if (self != null)
            return self;
        self = new RemoteBotEditorImp();
        return self;
    }
