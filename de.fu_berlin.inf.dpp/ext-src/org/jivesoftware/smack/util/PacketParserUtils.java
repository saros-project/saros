            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                // Otherwise, it must be a packet extension.
                    ...
                    message.addExtension(PacketParserUtils
                        .parsePacketExtension(elementName, namespace, parser));
                }
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                // Otherwise, it must be a packet extension.
                    ...
                    try {
                        ...
                        System.err
                            .println("Failed to parse extension packet in Presence packet.");
                    }
                }
            } else if (eventType == XmlPullParser.END_TAG) {
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                // this element name and namespace.
                    ...
                    // Only handle unknown IQs of type result. Types of 'get'
                    // and 'set' which are not understood
                    // have to be answered with an IQ error response. See the
                    // code a few lines below
                    else if (IQ.Type.RESULT == type) {
                        // No Provider found for the IQ stanza, parse it to an
                        // UnparsedIQ instance
                        // so that the content of the IQ can be examined later
                        // on
            ...
            if (eventType == XmlPullParser.START_TAG) {
                if (parser.getName().equals("item")) {
                    ...
                    RosterPacket.ItemType type = RosterPacket.ItemType
                        .valueOf(subscription != null ? subscription : "none");
