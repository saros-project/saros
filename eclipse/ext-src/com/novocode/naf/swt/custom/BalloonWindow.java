/**
 * ***************************************************************************** Copyright (c) 2004
 * Stefan Zeiger and others. All rights reserved. This program and the accompanying materials are
 * made available under the terms of the Eclipse Public License v1.0 which accompanies this
 * distribution, and is available at http://www.novocode.com/legal/epl-v10.html
 *
 * <p>Contributors: Stefan Zeiger (szeiger@novocode.com) - initial API and implementation
 * *****************************************************************************
 */
 ...
 *
 * <p>By default, a balloon window has no title bar or system controls. The following styles are
 * supported:
 *
 * <ul>
 *   <li>SWT.ON_TOP - Keep the window on top of other windows
 *   <li>SWT.TOOL - Add a drop shadow to the window (on supported platforms)
 *   <li>SWT.CLOSE - Show a "close" control on the title bar (implies SWT.TITLE)
 *   <li>SWT.TITLE - Show a title bar
 * </ul>
 *
...
public class BalloonWindow {
  ...
  /**
   * Adds a control to the list of controls which close the balloon window. The background, title
   * image and title text are included by default.
   */
  ...
  /**
   * Set the location of the anchor. This must be one of the following values: SWT.NONE,
   * SWT.LEFT|SWT.TOP, SWT.RIGHT|SWT.TOP, SWT.LEFT|SWT.BOTTOM, SWT.RIGHT|SWT.BOTTOM
   */
