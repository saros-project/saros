package saros.stf.test.stf.basicwidget;
...
import static saros.stf.shared.Constants.CM_RENAME;
import static saros.stf.shared.Constants.GROUP_TITLE_XMPP_JABBER_ACCOUNTS;
import static saros.stf.shared.Constants.MENU_CLOSE;
import static saros.stf.shared.Constants.MENU_FILE;
import static saros.stf.shared.Constants.MENU_NEW;
import static saros.stf.shared.Constants.MENU_OTHER;
import static saros.stf.shared.Constants.MENU_PACKAGE;
import static saros.stf.shared.Constants.MENU_PREFERENCES;
import static saros.stf.shared.Constants.MENU_SAROS;
import static saros.stf.shared.Constants.MENU_SHOW_VIEW;
import static saros.stf.shared.Constants.MENU_WINDOW;
import static saros.stf.shared.Constants.NODE_ANNOTATIONS;
import static saros.stf.shared.Constants.NODE_CONSOLE;
import static saros.stf.shared.Constants.NODE_CONTACTS;
import static saros.stf.shared.Constants.NODE_EDITORS;
import static saros.stf.shared.Constants.NODE_GENERAL;
import static saros.stf.shared.Constants.NODE_SAROS;
import static saros.stf.shared.Constants.NODE_TEXT_EDITORS;
import static saros.stf.shared.Constants.SHELL_NEW_JAVA_PACKAGE;
import static saros.stf.shared.Constants.SHELL_PREFERNCES;
import static saros.stf.shared.Constants.SHELL_SET_NEW_NICKNAME;
import static saros.stf.shared.Constants.SHELL_SHOW_VIEW;
import static saros.stf.shared.Constants.SRC;
import static saros.stf.shared.Constants.SUFFIX_JAVA;
import static saros.stf.shared.Constants.TB_COLLAPSE_ALL;
import static saros.stf.shared.Constants.VIEW_PACKAGE_EXPLORER;
