...
public class Editing3ProjectsTest extends StfTestCase {
    ...
    public void testEditing3Projects() throws Exception {
        ...
        ALICE.superBot().internal().createFile("foo", "src/bar/HelloAlice.java",
            "HelloAlice");
        ALICE.superBot().internal().createFile("foo1", "src/bar/HelloBob.java",
            "HelloBob");
        ALICE.superBot().internal().createFile("foo2", "src/bar/HelloCarl.java",
            "HelloCarl");
