package de.fu_berlin.inf.dpp.stf.selftest.internal;
...
public class InternalTest extends StfTestCase {
    ...
    public void testCreateJavaProject() throws Exception {
        ...
        assertTrue("resource does not exist", ALICE.superBot().internal()
            .existsResource("Hello"));
    }
    ...
    public void testCreateFolder() throws Exception {
        ...
        assertTrue("resource does not exist", ALICE.superBot().internal()
            .existsResource("foo/bar/a/b/c/d"));
    }
    ...
    public void testcreateFile() throws Exception {
        ...
        assertTrue("resource does not exist", ALICE.superBot().internal()
            .existsResource("Hello/a/b/c/d/e/f/g/abc.def"));

        assertTrue("resource does not exist", ALICE.superBot().internal()
            .existsResource("Hello/x/y/z/foo.bar"));

        assertTrue("resource does not exist", ALICE.superBot().internal()
            .existsResource("Hello/x/y/z/foo.bar.comp"));
    ...
    public void testGetFileContentAndCompressIt() throws Exception {
        ...
        ALICE.superBot().internal()
            .createFile("Hello", "x/y/z/foo.bar.comp", 1024 * 1024, true);

        byte[] content = ALICE.superBot().internal()
            .getFileContent("Hello", "x/y/z/foo.bar.comp");
        ...
        assertTrue("compressed file content is to large: "
            + compressedDataLength, compressedDataLength <= 5 * 1024);
    ...
    public void testGetFileContent() throws Exception {
        ...
        assertEquals("Kitzmann Bier", new String(ALICE.superBot().internal()
            .getFileContent("Hello", "bar")));
    }
