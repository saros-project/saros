 ...
 * concerning the handling of the IDE-specific part that contains the main view
 * of Saros's HTML GUI. This interface needs to be implemented individually for
 * each supported IDE.
 */
