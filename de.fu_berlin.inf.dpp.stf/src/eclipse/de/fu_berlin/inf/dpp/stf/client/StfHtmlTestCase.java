...
/**
 * Special type of {@link StfTestCase} which makes sure that all
 * {@linkplain #select(AbstractTester, AbstractTester...) selected testers}
 * actually support the HTML GUI before the tests get executed. Without HTML
 * GUIs enabled, the test cases will be simply ignored.
 */
