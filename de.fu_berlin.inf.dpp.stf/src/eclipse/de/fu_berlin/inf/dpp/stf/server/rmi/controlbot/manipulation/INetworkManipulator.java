...
public interface INetworkManipulator extends Remote {
    ...
    /**
     * Blocks incoming packets that are received from the given JID over XMPP.
    ...
    /**
     * Blocks outgoing packets that are send to the given JID over XMPP. Packets
    ...
    /**
     * Unblocks the given JID and continue to dispatch packets from this JID
     * over XMPP.
     * 
     * @param jid
     *            the JID to unblock
    ...
    /**
     * Unblocks the given JID and continues to send packets to this JID over
     * XMPP.
     * 
     * @param jid
     *            the JID to unblock
    ...
    /**
     * Controls whether all packets that are received from this JID should be
     * discarded or not.
     * 
     * @param jid
     *            the JID which packets should be discarded
     * @param discard
     *            <code>true</code> if all packets should be discarded,
    ...
    /**
     * Controls whether all packets that are send to this JID should be
     * discarded or not.
     * 
     * @param jid
     *            the JID which packets should be discarded
    ...
    /**
     * Blocks incoming packets that are received from the given JID in the
     * current Saros Session. Packets will be dispatched after the connection is
     * unblocked.
     * 
     * @param jid
     *            the JID to block
    ...
    /**
     * Blocks outgoing packets that are send to the given JID in the current
     * Saros Session. Packets will be dispatched after the connection is
     * unblocked.
     * 
     * @param jid
     *            the JID to block
    ...
    /**
     * Unblocks the given JID and continue to dispatch packets from this JID in
     * the current Saros Session.
     * 
     * @param jid
     *            the JID to unblock
     * @throws RemoteException
    ...
    /**
     * Unblocks the given JID and continues to send packets to this JID in the
