...
public final class RunAsContextMenu extends StfRemoteObject implements
    IRunAsContextMenu {
    ...
    public void javaApplication() throws RemoteException {
        treeItem.select();
        ContextMenuHelper.clickContextMenuWithRegEx(tree, CM_RUN_AS,
            "\\d*+\\s*+" + CM_JAVA_APPLICATION);
    }
}
