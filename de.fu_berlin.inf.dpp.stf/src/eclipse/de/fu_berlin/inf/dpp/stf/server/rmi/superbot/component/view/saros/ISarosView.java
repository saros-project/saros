...
public interface ISarosView extends Remote {
     ...
     * 
     * @param jid
     *            the {@link JID} of the contact to add
     * @throws RemoteException
     */
     ...
     * 
     */
    public IContextMenusInSessionArea selectUser(JID jid)
        throws RemoteException;
    ...
    /**
     * Checks if the contact given by the JID exists in the contact list of the
     * currently logged in tester.
     * 
     * @param jid
    ...
    /**
     * Returns the nickname of a contact from the contact list of the currently
     * logged in tester.
     * 
     * @Note The implementation may bypass the GUI.
     * 
     * @param jid
     *            {@link JID} of the contact
     * @return the nickname of the given contact or <code>null</code> if there
     *         is no nickname for that contact
     * @throws RemoteException
     */
    public String getNickname(JID jid) throws RemoteException;

    /**
     * Check if a nickname for the contact exists in the contact list of the
     * currently logged in tester.
     * 
     * @Note The implementation may bypass the GUI.
     * 
     * @param jid
     *            {@link JID} of the contact
     * @return <code>true</code>, if the given contact has a nickname,
    ...
    /**
     * Returns a list of all contacts names that are available in the contact
     * list of the currently logged in tester.
     * 
     * 
     * @return list of all contacts names as <b>displayed</b> in the contact
     *         list tree node
     * @throws RemoteException
     */
     ...
     * 
     * @return <code>true</code> if the tester is currently in a session,
     *         <code>false</code> otherwise
     * 
     * @throws RemoteException
     */
     ...
     * @param jid
     *            {@link JID}
     * @return <code>true</code> if the contact is a user in the current
     ...
     * 
     * @return <code>true</code> if the tester is the host of the current
     *         session, <code>false</code> otherwise
     * @throws RemoteException
     */
    ...
    /**
     * Check if the tester is following another user in the current session.
     * 
     * @Note The implementation may bypass the GUI.
     * 
     * @return <code>true</code> if the tester is following another session
     ...
     * 
     * @return list of all user names as <b>displayed</b> in the session tree
     *         node
     * @throws RemoteException
     */
    ...
    /**
     * Returns the JID of the user that the tester is currently following.
     * 
     * @Note The implementation may bypass the GUI.
     * 
     * @return the {@link JID} of the followed user or <code>null</code> if the
     *         tester is currently not following anyone.
     */
    ...
    /**
     * Wait until the condition {@link ISarosView#existsUser(JID)} for all
     * participants is false.
     * 
