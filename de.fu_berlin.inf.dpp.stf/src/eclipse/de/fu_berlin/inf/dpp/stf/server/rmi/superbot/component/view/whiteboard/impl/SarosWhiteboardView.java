...
public class SarosWhiteboardView extends StfRemoteObject implements
    ISarosWhiteboardView {
    ...
    public ISarosWhiteboardView setView(SWTBotView view, SWTWorkbenchBot bot) {
        ...
        this.zoomManager = (ZoomManager) this.view.getReference().getView(true)
    ...
    @Override
    public IWhiteboardFigure getFigureFromEditPartID(String label)
        throws RemoteException {
        return getWhiteboardFigure(((GraphicalEditPart) viewer
            .getEditPart(label)).getFigure());
    }
    ...
    public IWhiteboardFigure getFigureAt(int x, int y) throws RemoteException {
        ...
        if (editParts == null || editParts.isEmpty())
            return null;
        IFigure figure = ((GraphicalEditPart) editParts.get(0).part())
            .getFigure();
    ...
    public void toggleMaximize() throws RemoteException {
        view.bot().menu("Window").menu("Navigation")
