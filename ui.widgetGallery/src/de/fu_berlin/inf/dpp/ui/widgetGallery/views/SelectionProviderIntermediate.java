 ...
 * @see <a href="http://www.eclipse.org/articles/Article-WorkbenchSelections/article.html">Eclipse
 *     Workbench: Using the Selection Service</a>
 */
public class SelectionProviderIntermediate implements IPostSelectionProvider {
  ...
  /**
   * Sets a new selection provider to delegate to. Selection listeners registered with the previous
   * delegate are removed before.
   *
