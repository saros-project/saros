...
public class SVGTextBoxRecord extends LayoutElementRecord {
    ...
    public List<IRecord> createLayoutRecords(Rectangle layout,
        ...
        records.add(createNewOrSetAttributeRecord(null,
            ...
            onlyCreateNewRecords));
        records.add(createNewOrSetAttributeRecord(null,
            SVGConstants.SVG_WIDTH_ATTRIBUTE, String.valueOf(layout.width),
            onlyCreateNewRecords));
        records.add(createNewOrSetAttributeRecord(null,
            SVGConstants.SVG_HEIGHT_ATTRIBUTE, String.valueOf(layout.height),
            onlyCreateNewRecords));
        records.add(createNewOrSetAttributeRecord(null,
        ...
        records.add(createNewOrSetAttributeRecord(null,
            ...
            onlyCreateNewRecords));
        log.trace("create Layout Records: Text:" + this.text + " X:" + layout.x
            + " Y:" + layout.y + " Width:" + layout.width + " Height:"
            + layout.height);
        return records;
    }
