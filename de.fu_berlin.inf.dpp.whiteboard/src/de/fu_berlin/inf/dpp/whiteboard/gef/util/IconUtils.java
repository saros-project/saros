...
public class IconUtils {
    ...
    public static Image getAnnotationImage() {
        ...
        if (i == null) {
            i = resize(Display.getDefault()
                .getSystemImage(SWT.ICON_INFORMATION), LOW_HEIGHT, LOW_HEIGHT);
    ...
    private static Polyline getPencilIconFigure() {
        ...
        int[] rawPoints = { 11, 3, 6, 3, 6, 4, 3, 4, 3, 5, 2, 5, 1, 6, 1, 8, 2,
            8, 2, 9, 3, 9, 4, 9, 5, 8, 7, 8, 7, 7, 8, 7, 8, 6, 13, 6, 14, 7,
            14, 10, 13, 10, 13, 11, 9, 11, 9, 12, 7, 12 };
        PointList points = new PointList(rawPoints);
        line.setPoints(points);
        line.setForegroundColor(black);
        return line;
    ...
    private static IFigure getBackgroundColorIconFigure() {
        ...
        rect.setBackgroundColor(new Color(null, ColorUtils
    ...
    private static IFigure getForegroundColorIconFigure() {
        log.debug("create foreground icon with color "
            + ColorUtils.getRGBForegroundColor());
        RectangleFigure rect = new RectangleFigure();
        rect.setForegroundColor(black);
        rect.setBackgroundColor(new Color(null, ColorUtils
