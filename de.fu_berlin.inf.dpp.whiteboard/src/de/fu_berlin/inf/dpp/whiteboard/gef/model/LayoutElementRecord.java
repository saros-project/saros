...
/**
 * <p>
 * Base class for records that understand GEF's layout mechanic. Thus it allows
 * to convert a {@link Rectangle} to a list of records.
 * </p>
 * 
 * @author jurke
 * 
...
public abstract class LayoutElementRecord extends ElementRecord {
	...
	/**
	 * <p>
	 * This method will return <code>AttributeRecord</code>s that define the
	 * layout rectangle of this element or if the attribute exists a
	 * <code>SetRecord</code>s to update the layout respectively.
	 * </p>
	 * 
	 * <p>
	 * Note, omits <code>SetRecord</code>s that are not changed by the new
	 * layout.
	 * </p>
	 * 
	 * @param layout
	 ...
	 *            whether not to return a SetRecord if the record exists already
	 *            but a new attribute record
	...
	/**
	 * Utility method to remove <code>SetRecord</code> that do not change
	 * anything. Thus implementing subclasses do not have to check this for
	 * every attribute.
	 * 
	 * @param records
	 */
