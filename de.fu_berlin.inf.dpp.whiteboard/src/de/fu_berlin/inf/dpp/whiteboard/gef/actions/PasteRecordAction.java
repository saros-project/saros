...
/**
 * Action used to create and executed paste commands that past content of the
 * clipboard to the document.</br>
 * 
 * It maintains a counter to inform the command about how many times these
 * contents were inserted already (for position shifting).
 * 
 * @author jurke
 * 
 */
