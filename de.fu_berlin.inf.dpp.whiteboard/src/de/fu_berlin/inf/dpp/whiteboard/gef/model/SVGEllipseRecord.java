...
public class SVGEllipseRecord extends LayoutElementRecord {
    ...
    public List<IRecord> createLayoutRecords(Rectangle layout,
        ...
        records.add(createNewOrSetAttributeRecord(null,
            ...
            String.valueOf(layout.y + layout.height / 2), withoutSetRecords));
        records.add(createNewOrSetAttributeRecord(null,
            SVGConstants.SVG_RX_ATTRIBUTE, String.valueOf(layout.width / 2),
            withoutSetRecords));
        records.add(createNewOrSetAttributeRecord(null,
            SVGConstants.SVG_RY_ATTRIBUTE, String.valueOf(layout.height / 2),
            withoutSetRecords));
        records
