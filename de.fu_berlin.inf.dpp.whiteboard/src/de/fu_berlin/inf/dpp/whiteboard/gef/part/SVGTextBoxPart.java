...
/**
 * this class acts as Listener on changes in the records, it calls different
 * methods on creation and editing of the figure
 * 
 * @author Markus
 * 
 */
public class SVGTextBoxPart extends ElementRecordPart {
    ...
    /**
     * Refreshes the Text displayed in the figure with the text saved in the
     * model
     * 
     * @param text
     */
    protected void refreshText() {
        ...
        if (r != null) {
            ...
            Font classFont = new Font(null, TEXT_TYPE,
                (int) (TEXT_SIZE / getCurrentZoom()), SWT.NORMAL);
             ...
             */
            log.trace("refresh text: old:" + oldtext + " - "
                + (oldtext == "null") + "," + (oldtext == null) + " new:" + s
                + " - " + (s == "null") + "," + (s == null));
