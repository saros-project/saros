...
/**
 * An adaption of the GEF CommandStack that will convert a
 * {@link org.eclipse.gef.commands.CompoundCommand} to the SXE correspondent to
 * transmit only a single list of <code>IRecord</code>s to the controller.
 * 
 * @author jurke
 * 
...
public class SXECommandStack extends CommandStack {
	...
	/**
	 * Compounds all <code>SXECommand</code>s in an SXECompoundCommand and
	 * leaves other commands untouched.
	 * 
	 * @param cc
	 * @return a new command that will execute all SXECommands as one list of
	 *         records
	 */
	...
	/**
	 * Unfortunately GEF does not allow to flush redo without flushing undo
