...
/**
 * This class maintains a cache of the SVG points attribute. Parsing the String
 * on every access would be pretty expensive because this attribute quickly
 * grows to some thousand points.
 * 
 * 
 * @author jurke
 * 
...
public class SVGPolylineRecord extends LayoutElementRecord {
     ...
     * respectively the provided layout rectangle
     */
    @Override
    public List<IRecord> createLayoutRecords(Rectangle layout,
        ...
        records
            .add(createNewOrSetAttributeRecord(null,
