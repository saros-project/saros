...
/**
 * For efficiency reasons we use a custom DeleteAction that uses a
 * {@link de.fu_berlin.inf.dpp.whiteboard.sxe.util.HierarchicalRecordSet} to
 * create only <code>RemoveRecord</code>s for the top-most
 * <code>ElementRecord</code>s.
 * 
 * @author jurke
 * 
 */
