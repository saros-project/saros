...
public class BrowserActionExecuter {
    ...
    private static final Logger LOG = Logger
        .getLogger(BrowserActionExecuter.class);
    ...
    private List<IRecord> create(BrowserAction action) {
        ...
        ElementRecord newElement = parent.createNewElementRecord(null,
    ...
    private List<IRecord> setAttributes(ElementRecord element,
        List<Map<String, String>> attributes) {
        List<IRecord> records = new ArrayList<IRecord>();
        for (Map<String, String> attribute : attributes) {
            IRecord record = element.createNewOrSetAttributeRecord(null,
                attribute.get("name"), attribute.get("chdata"), false);
    ...
    private ElementRecord getElement(String id) {
        try {
            ...
            LOG.error("trying to access an element that does NOT"
                + " exist, the changes will be ignored.", e);
            return null;
        }
    }
