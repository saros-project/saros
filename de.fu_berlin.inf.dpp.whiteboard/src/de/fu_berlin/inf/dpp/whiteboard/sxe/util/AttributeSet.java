...
/**
 * A list of AttributeRecords that wraps a HashMap to accelerate the access of
 * an AttributeRecord by its RID.
 * 
 * @author jurke
 * 
 */
public class AttributeSet extends NodeSet<AttributeRecord> {
	...
	public boolean removeAll(Collection<?> c) {
		for (Object r : c) {
			if (r instanceof AttributeRecord)
				map.remove(((AttributeRecord) r).getName());
		}
