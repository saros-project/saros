...
public class SXEMessageWriter {
    ...
    public static class SXEStreamWriter {
        ...
        public void startMessage(SXEMessage session) throws SAXException {
            ...
            atts.addAttribute("", "", "session", "CDATA", session.getSession()
                .getSessionId());
        ...
        public void writeStateOffer() throws SAXException {
            ...
            atts.addAttribute("", "", "xmlns", "CDATA",
                "urn:xmpp:apps:saros-whiteboard");
        ...
        public void writeRecords(List<RecordDataObject> rdos)
            throws SAXException {
        ...
        public void writeState(List<RecordDataObject> records)
            throws SAXException {
        ...
        protected void writeRecord(RecordDataObject rdo) throws SAXException {
            handler.startElement("", "", rdo.getRecordType().toString(),
                getAttributes(rdo.getValuePairs()));
        ...
        public Attributes getAttributes(Map<RecordEntry, String> valuePairs) {
            ...
            for (Entry<RecordEntry, String> e : valuePairs.entrySet()) {
                atts.addAttribute("", "", e.getKey().toString(), "CDATA",
                    e.getValue());
            }
            return atts;
        }
