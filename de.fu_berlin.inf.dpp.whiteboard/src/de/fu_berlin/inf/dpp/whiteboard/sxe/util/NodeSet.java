...
/**
 * <p>
 * This extension of a TreeSet ensures that records with empty primary-weight
 * are initialized to be added at the end.
 * </p>
 * 
 * <p>
...
public class NodeSet<T extends NodeRecord> extends TreeSet<T> {
	...
	/**
	 * This method is used to increase the possibility to have different
	 * primary-weight values for every peer, even on concurrent creation.</br>
	 * 
	 * This is useful because if comparing per secondary-weight (the RIDs) only,
	 * it's more effort to insert an element in between.
	 * 
	...
	/**
	 * Adds the record to this set. If no primary weight is specified, it will
	 * be added to the end.
	 */
	@Override
	...
	public boolean contains(Object o) {
		if (o instanceof NodeRecord) {
			if (((NodeRecord) o).getPrimaryWeight() == null)
				return false;
