...
public class SXEDefaultRecordFactory implements ISXERecordFactory {
     ...
     */
    @Override
    public ElementRecord createElementRecord(DocumentRecord document,
     ...
     */
    @Override
    public AttributeRecord createAttributeRecord(DocumentRecord document,
        String ns, String name, String chdata) {
