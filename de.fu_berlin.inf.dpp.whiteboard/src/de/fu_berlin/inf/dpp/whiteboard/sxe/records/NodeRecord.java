...
/**
 * <p>
 * Abstract implementation of a DOM node in context of Shared XML Editing
 * XEP-0284 (SXE).
 * </p>
 * 
 * <p>
 * It maintains the common mutable and immutable fields of attribute and element
 * nodes. By this a list of setRecords, sorted by version, and the possibility
 * to apply SetRecords and RemoveRecords.
 * </p>
 * 
 * <p>
 * Note: In difference to SXE, name and namespace are seen an immutable fields
 * because this does not make sense respective SVG whiteboarding.
 * </p>
 * 
 * <p>
 * The primary-weight defines the position of this record in its parent's child
 * node list. If left empty it is set automatically when applying to add this
 * record to the end.
 * </p>
 * 
 * @author jurke
...
public abstract class NodeRecord extends AbstractRecord implements
    ...
    /**
     * <p>
     * Beware of using this method. Should only be used during start
     * synchronization to skip missing versions. This is expected because due to
     * conflicts SetRecords may have been discarded.</br>
     * 
     * However in a running session this must be an error.
     * </p>
     * 
     * @throws IllegalArgumentException
     *             if the passed version is smaller than the current one
     */
    public void repairVersion(int version) {
        if (this.version > version)
            throw new IllegalArgumentException(
                "Can only skip version, not set it back.");
        this.version = version;
    }
    ...
    public String getLastModifiedBy() {
        if (setRecords.isEmpty())
            return initialSet.getLastModifiedBy();
    ...
    public int compareTo(NodeRecord record) {
        if (this == record)
            return 0;
        if (getPrimaryWeight() < record.getPrimaryWeight())
            return -1;
        if (getPrimaryWeight() > record.getPrimaryWeight())
            return 1;
    ...
    public final boolean applySetRecord(SetRecord setRecord) {
        ...
        if (getParent() == null && setRecord.getParentToChange() != null)
            return false;
    ...
    protected SetRecord getNewStateAndRevertHistory(int version) {
        ...
        if (!setTo.setsAllMutableFields())
            setTo.fillEmptyMutableFieldsFrom(initialSet);
        return setTo;
    }

    /**
     * <p>
     * Set mutable fields to these provided by setRecord. Does nothing for
     * fields == null.
     * </p>
     * 
     * <p>
     * On primary-weight change, this record is re-attached to its parent (to
     * achieve correct ordering).
     * </p>
     * 
     * @param setRecord
     */
    ...
    /**
     * Returns a SetRecord that appends this record to another parent as last
     * child.
     * 
     * @param newParent
    ...
    /**
     * 
     * @return a new-record as copy of this one, without set-records and with a
     *         new RID
     */
    ...
    public boolean canApply() {
        try {
            if (!getDocumentRecord().contains(getParent()))
                return false;
            return true;
        } catch (Exception e) {
            return false;
