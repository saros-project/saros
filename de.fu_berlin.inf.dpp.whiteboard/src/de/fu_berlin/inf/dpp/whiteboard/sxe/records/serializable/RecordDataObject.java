...
/**
 * <p>
 * Base class for serializable records. This class uses the enum
 * {@link RecordEntry} to maintain the records' fields and offers respective
 * setter methods.
 * </p>
 * 
 * <p>
...
public abstract class RecordDataObject implements Serializable {
     ...
     *             if there is no RID this data object does not correspond to a
     *             valid record
     */
    ...
    /**
     * <p>
     * Note: under certain conditions this record may return a different type
     * than defined in the RecordType field due to concurrent edits.
     * </p>
     * <p>
     * Subclasses have to ensure to provide a record that sets the document in a
     * synchronized state or throw a MissingRecordException.
     * </p>
     * 
     * @param document
     * @return a record to set the document in a synchronized state
     * @throws MissingRecordException
     *             if a field references a missing record
     */
    public abstract IRecord getIRecord(DocumentRecord document)
        throws MissingRecordException;

    /**
     * 
     * @param document
     *            the document record where it may have been applied to
     * @return whether the corresponding IRecord was already applied locally
     * @throws MissingRecordException
     *             if a target (i.e. SetRecord, RemoveRecord) is missing
     *             completely
     */
    public abstract boolean isAlreadyApplied(DocumentRecord document)
        throws MissingRecordException;
}
