...
* You need a **Java 11 JDK** (preferred [Eclipse Temurin](https://adoptium.net/de/temurin/releases?version=11)) or using [SDKMAN](https://sdkman.io/install) to manage [multiple JDKs](https://sdkman.io/jdks)).
