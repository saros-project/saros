...
public abstract class SASLMechanism implements CallbackHandler {
    ...
    public static class Challenge extends Packet {
        ...
        public String toXML() {
            StringBuilder stanza = new StringBuilder();
            stanza
                .append("<challenge xmlns=\"urn:ietf:params:xml:ns:xmpp-sasl\">");
    ...
    public class Response extends Packet {
        ...
        public String toXML() {
            StringBuilder stanza = new StringBuilder();
            stanza
                .append("<response xmlns=\"urn:ietf:params:xml:ns:xmpp-sasl\">");
            if (authenticationText != null) {
                stanza.append(authenticationText);
            }
    ...
    public static class Success extends Packet {
        ...
        public String toXML() {
            StringBuilder stanza = new StringBuilder();
            stanza
                .append("<success xmlns=\"urn:ietf:params:xml:ns:xmpp-sasl\">");
            if (data != null && data.trim().length() > 0) {
                stanza.append(data);
            }
    ...
    public static class Failure extends Packet {
        ...
        public String toXML() {
            StringBuilder stanza = new StringBuilder();
            stanza
                .append("<failure xmlns=\"urn:ietf:params:xml:ns:xmpp-sasl\">");
