...
public class SASLGSSAPIMechanism extends SASLMechanism {
  ...
  /**
   * Builds and sends the <tt>auth</tt> stanza to the server. This overrides from the abstract class
   * because the initial token needed for GSSAPI is binary, and not safe to put in a string, thus
