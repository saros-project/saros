 ...
 * <tr>
 * <td>conflict</td>
 * <td>the server is closing the active stream for this entity because a new
 * stream has been initiated that conflicts with the existing stream.</td>
 * </tr>
 * <tr>
 * <td>connection-timeout</td>
 * <td>the entity has not generated any traffic over the stream for some period
 * of time.</td>
 * </tr>
 * <tr>
 * <td>host-gone</td>
 * <td>the value of the 'to' attribute provided by the initiating entity in the
 ...
 * <tr>
 * <td>invalid-from</td>
 * <td>the JID or hostname provided in a 'from' address does not match an
 * authorized JID.</td>
 * </tr>
 * <tr>
 * <td>invalid-id</td>
 * <td>the stream ID or dialback ID is invalid or does not match an ID
 * previously provided.</td>
 * </tr>
 * <tr>
 ...
 * <td>the entity has attempted to send data before the stream has been
 * authenticated</td>
 * </tr>
 * <tr>
 ...
 * <td>the server will not provide service to the initiating entity but is
 * redirecting traffic to another host.</td>
 * </tr>
 * <tr>
 ...
 * <td>the error condition is not one of those defined by the other conditions
 * in this list.</td>
 * </tr>
 * <tr>
 * <td>unsupported-encoding</td>
 * <td>the initiating entity has encoded the stream in an encoding that is not
 * supported.</td>
 * </tr>
 * <tr>
 * <td>unsupported-stanza-type</td>
 * <td>the initiating entity has sent a first-level child of the stream that is
 * not supported.</td>
 * </tr>
 * <tr>
 * <td>unsupported-version</td>
 * <td>the value of the 'version' attribute provided by the initiating entity in
 * the stream header specifies a version of XMPP that is not supported.</td>
 * </tr>
 * <tr>
