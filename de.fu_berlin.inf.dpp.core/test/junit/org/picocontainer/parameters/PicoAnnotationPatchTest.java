...
public class PicoAnnotationPatchTest {
    ...
    public void testCustomPicoAnnotationPatch() {
        ...
        container.addComponent(BindKey.bindKey(String.class, TheString.class),
            THE_STRING);

        container.addComponent(
            BindKey.bindKey(String.class, NotTheString.class), NOT_THE_STRING);

        container = container.makeChildContainer();

        container.addComponent(TheClass.class);

        assertEquals(THE_STRING,
            container.getComponent(TheClass.class).theString);
    }
}
