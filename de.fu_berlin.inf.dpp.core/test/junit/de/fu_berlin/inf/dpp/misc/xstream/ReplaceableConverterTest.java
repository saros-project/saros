...
public class ReplaceableConverterTest {
    ...
    public void reset() {
        ...
        /*
         * Verify that each converter was used exactly once, i.e. the first one
         * was not called while it was inactive.
         */
        EasyMock.verify(c1);
    }
    ...
    public void replace() {
        ...
        c2.marshal(isA(Object.class), isA(HierarchicalStreamWriter.class),
            isA(MarshallingContext.class));
        EasyMock.expectLastCall().once();
        ...
        assertNotNull("Converter was not reactivated",
            xstream.toXML(new Dummy()));
