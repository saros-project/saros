...
public class SPathConverterTest {
    ...
    public void conversionRunningSession() {
        ...
        expect(session.getReferencePointID(referencePoint))
            .andStubReturn("ABC");
        expect(session.getReferencePoint("ABC")).andStubReturn(referencePoint);
        expect(session.getComponent(IReferencePointManager.class))
    ...
    public void conversionLeavingReceiver() {
        ...
        expect(senderSession.getReferencePointID(referencePoint))
            .andStubReturn("ABC");
        expect(senderSession.getReferencePoint("ABC")).andStubReturn(
            referencePoint);

        ISarosSession receiverSession = EasyMock
            .createMock(ISarosSession.class);
        expect(receiverSession.getReferencePointID(referencePoint)).andReturn(
            "ABC");
        expect(receiverSession.getReferencePoint("ABC")).andReturn(
            referencePoint);
        expect(receiverSession.getReferencePointID(referencePoint)).andReturn(
            null);
        ...
        XStream sender = new XStream(new DomDriver());
        sender
            .registerConverter(new SPathConverter(senderSession, pathFactory));

        XStream receiver = new XStream(new DomDriver());
        receiver.registerConverter(new SPathConverter(receiverSession,
            pathFactory));
    ...
    public void conversionLeavingSender() {
        /* Mocks */
        ISarosSession senderSession = EasyMock.createMock(ISarosSession.class);
        expect(senderSession.getReferencePointID(referencePoint)).andReturn(
            "ABC");
        expect(senderSession.getReferencePoint("ABC"))
            .andReturn(referencePoint);
        expect(senderSession.getReferencePointID(referencePoint)).andReturn(
            null);
        ...
        ISarosSession receiverSession = EasyMock
            .createMock(ISarosSession.class);
        expect(receiverSession.getReferencePointID(referencePoint))
            .andStubReturn("ABC");
        expect(receiverSession.getReferencePoint("ABC")).andStubReturn(
            referencePoint);
        expect(receiverSession.getReferencePoint(EasyMock.isNull(String.class)))
            .andStubReturn(null);
