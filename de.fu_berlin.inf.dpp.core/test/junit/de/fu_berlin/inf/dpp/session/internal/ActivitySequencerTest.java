...
public class ActivitySequencerTest {
  ...
  public void setUp() {
    ...
    aliceUser = new User(ALICE_JID, true, true, false, 0, 0);
    bobUser = new User(BOB_JID, false, true, false, 0, 0);
  ...
  public void testUnregisterUserOnTransmissionFailure() {
    ...
    User bobUserInAliceSession = new User(BOB_JID, false, false, false, 0, 0);
  ...
  public void testSendAndFlushAndReceiveAndOrder() {
    ...
    User bobUserInAliceSession = new User(BOB_JID, false, false, false, 0, 0);
    User aliceUserInBobSession = new User(ALICE_JID, true, false, false, 0, 0);
