...
public class JGitFacadeTest {
  ...
  /**
   * Method to create file,folder and .git Directory with a given number of commits. Commits can be
   * accessed by Tag (The first is named CheckoutAtInit, the following
   * CheckoutAtCommit2,CheckoutAtCommit3,...)
   *
   * @param iD Test should never use the same iD twice
   * @param amountCommits At least 1 will be created. If >= 2 more than that.
   * @return The file that will be used to identify the folder with the Git Directory
   */
  ...
  public void testCreateBundle() throws IOException {
    ...
    File bundle = JGitFacade.createBundleByTag(firstRepoTempFile, "CheckoutAtInit");
