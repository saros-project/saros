...
public class PreferenceStoreTest {
    ...
    public void testGetDefaultDefaultValues() {
        ...
        assertEquals(PreferenceStore.DEFAULT_BOOLEAN,
            store.getDefaultBoolean("foo"));

        assertEquals(PreferenceStore.DEFAULT_STRING,
            store.getDefaultString("foo"));
    ...
    public void testSetValueNonASCIICharacters() {
        ...
        assertEquals(data,
            store.getString("hello.kitty.with.xml.control.characters"));
    }
    ...
    public void testPreferenceChange() {
        ...
        final IPreferenceChangeListener listener = new IPreferenceChangeListener() {
        ...
        assertEquals(
            "changing default values must not result in change events", 0,
            changeEvents.size());
        ...
        assertEquals("at least one preference change was not broadcasted", 4,
            changeEvents.size());
