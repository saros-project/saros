...
public class ColorIDSetTest {
  ...
  public void setUp() {
    ...
    alice = new User(new JID("alice@saros.org"), false, false, false, 0, -1);
    bob = new User(new JID("bob@saros.org"), false, false, false, 1, -1);
    carl = new User(new JID("carl@lagerfeld.org"), false, false, false, 2, -1);
    dave = new User(new JID("dave@saros.org"), false, false, false, 0, -1);
  }
