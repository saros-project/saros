...
/**
 * Abstraction layer to the underlying UI event loop in terms of the platform
 * event model. Should only be used in non-UI components.
 * 
...
public interface UISynchronizer {
     ...
     * 
     * @return <code>true</code> if the current thread is the user-interface
