...
public interface IAccountStoreListener {
     ...
     * account was successfully completed. Will also be called after the store
     ...
     *            <p>
     *            Is never <code>null</code>; if the account store is empty or
     *            not yet initialized, the list is empty.
     */
     ...
     * Will also be called after the store has been initialized.
     * 
     * @param activeAccount
     *            The currently active account. May be identical with the
     *            previously active account.
     *            <p>
     *            Will be <code>null</code> if the account store has no active
     *            account yet (e.g. during start up or for first-time Saros
     *            users).
     */
