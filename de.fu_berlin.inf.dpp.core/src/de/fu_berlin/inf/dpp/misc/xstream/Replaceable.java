...
abstract class Replaceable<T> {
     ...
     * <p>
     * Implementation can call {@link #isReset()} to ensure that no calls reach
     * the delegate.
     */
    ...
    /**
     * Replaces the current {@link #delegate} with the given one. Does nothing
     * if the given delegate is <code>null</code>.
     * 
     * @see #isReset()
     */
