...
public class SoundPlayer {
    ...
    /**
     * Plays the given file on the default audio system. This method blocks
    ...
    public static void playSound(final File file) {
        ...
        try {
            ...
            LOG.warn("no audioline available, could not play audio file: "
                + file.getName(), e);
        ...
        try {
            ...
            LOG.error(
                "I/O error while streaming audio file: " + file.getName(), e);
            return;
        } finally {
            audioLine.drain();
            audioLine.close();
