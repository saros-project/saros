...
/**
 * Interface for displaying the progress of a {@link RemoteProgressMonitor} on
 * the progress-activity-receiving side. Implementations are
 * application-specific and accompanied by a matching
 * {@link IRemoteProgressIndicatorFactory}.
 */
public interface IRemoteProgressIndicator {
    ...
    /**
     * Starts displaying remote progress passed in through
     * {@link #handleProgress} to the user.
     */
    public void start();

    /**
     * Stops displaying remote progress to the user. It is assumed that
     * {@link #handleProgress} is not called anymore after {@link #stop()}.
     */
    public void stop();
