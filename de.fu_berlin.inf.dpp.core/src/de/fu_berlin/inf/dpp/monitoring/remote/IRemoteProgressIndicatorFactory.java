...
/**
 * Interface for constructing {@link IRemoteProgressIndicator} instances of the
 * correct (application-specific) type.
 */
...
public interface IRemoteProgressIndicatorFactory {
     ...
     *            ID of the remote user's {@link RemoteProgressMonitor} to watch
     * @param remoteUser
     *            the user who owns the watched remote progress monitor
