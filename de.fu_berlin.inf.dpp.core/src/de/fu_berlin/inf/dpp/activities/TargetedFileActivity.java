...
public class TargetedFileActivity extends FileActivity
     ...
     * @param target
     *            the target user to receive this Activity
     * @param type
     *            Type of this FileActivity (see {@link FileActivity.Type})
     * @param newPath
     *            where to save the data (if {@link FileActivity.Type#CREATED}),
     *            destination of a move (if {@link FileActivity.Type#MOVED}),
     *            file to remove (if {@link FileActivity.Type#REMOVED}); never
     *            <code>null</code>
     * @param oldPath
     *            if type is {@link FileActivity.Type#MOVED}, the path from
     *            where the file was moved (<code>null</code> otherwise)
     * @param content
     *            content of the file denoted by the path (only valid for
     *            {@link FileActivity.Type#CREATED} and
     *            {@link FileActivity.Type#MOVED})
     * @param encoding
    ...
    public String toString() {
        return "TargetedFileActivity [target=" + target + "purpose=" + purpose
            + ", dst:path=" + getPath() + ", src:path="
