 ...
 * 
 *               The StopActivity is created by the StopManager#stop() method,
 *               it contains the kind of request and the #user that should be
 *               stopped.
 */
/**
 * A StopActivity is used for signaling to a user that he should be stopped or
 * started (meaning that no more Activities should be generated by this user).
 */
