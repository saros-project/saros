...
public interface ISessionListener {
    ...
    /**
     * Is fired when an user leaves the reference point.
     * <p>
     * This method is called on the UI thread.
     * </p>
     * 
    ...
    /**
     * Is fired then a referen point has been made part of the session, either
     ...
     * unshared folder of a partially shared reference point).
     * <p>
     * This method might <i>not</i> be called on the UI thread.
     * </p>
     * 
     * @param referencePoint
     *            the reference point that was added
     * 
     */
    public void referencePointAdded(IReferencePoint referencePoint);

    /**
     * Is fired then a reference point has been removed from the session,
     * meaning it is not shared between the session's users anymore.
     * <p>
     * This method might <i>not</i> be called on the UI thread.
     * </p>
     * 
     * @param referencePoint
     *            the reference point that was removed
     */
