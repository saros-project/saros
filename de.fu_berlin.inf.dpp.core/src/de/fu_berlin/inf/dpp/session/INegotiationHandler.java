...
public interface INegotiationHandler {
     ...
     * 
     * @param negotiation
     *            the negotiation to use for executing the invitation
     */
     ...
     * 
     * @param negotiation
     *            the negotiation to use for handling the invitation
     */
     ...
     * 
     * @param negotiation
     *            the negotiation to use for executing the project
     *            synchronization
     */
     ...
     * 
     * @param negotiation
     *            the negotiation to use for handling the project
     *            synchronization
     */
