...
/**
 * An interface for implementing a factory that is able to convert
 * {@link de.fu_berlin.inf.dpp.filesystem.IPath path} objects to their string
 * representation and vice versa. Implementations must throw the given
 * {@link RuntimeException runtime exceptions} as declared in the method
 * signatures.
 */
