 ...
 * because it must be always possible to communicate with older and newer Saros
 * Version to determine compatibility.
 * <p>
 * To offer the most generic solution possible this packet does not contain any
 * detailed data but allows exchanging variable data in it is string
 * representation.
 * 
 */
