...
public class ChatElement {
    /**
     * Represents the type of a chat element. For {@link ChatElement}s, those
     * types change their textual representation.
     */
    ...
    /**
     * Create a chat element with the given chat element type. The message will
     * be empty. This can be for example leave- and join-notifications.
     * 
     * @param jid
     *            JID of the user to whom the element refers to, e.g. which user
     *            joined or left
     * @param date
     *            date of the occurrence, e.g. the joining or leaving
     * @param type
     *            type of the new chat element
     */
    ...
    /**
     * Construct a chat element with the given message body. The type of this
     * element will be {@link ChatElementType#MESSAGE}.
     * 
     * @param message
     *            message body of the chat element
     * @param jid
     *            sender of the message
     * @param date
     *            date the message has been received
     */
    ...
    /**
     * Construct a chat element that represents a normal chat message. The type
     * of this element will be {@link ChatElementType#MESSAGE}.
     * 
     * @param message
     *            The message from which the body and the sender will be
     *            extracted
     * @param date
     *            date the message has been received
     */
    ...
    /**
     * Construct a chat element that represents a chat state change (type
     * {@link ChatElementType#STATECHANGE}). The message will be empty.
     * 
     * @param jid
     *            JID of the user whose chat state has changed
     * @param date
     *            date of the chat state change
     * @param state
     *            new chat state
     */
