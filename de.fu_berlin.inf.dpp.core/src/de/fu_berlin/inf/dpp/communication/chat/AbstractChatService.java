...
/**
 * Parent class for chat services. It provides convenience methods for notifying
 * registered listeners.
 */
public abstract class AbstractChatService implements IChatService {
    private List<IChatServiceListener> chatServiceListeners = new CopyOnWriteArrayList<IChatServiceListener>();
     ...
     */
    @Override
    public void removeChatServiceListener(
        IChatServiceListener chatServiceListener) {
        chatServiceListeners.remove(chatServiceListener);
    }

    /**
     * Notify all {@link IChatServiceListener}s that an {@link IChat} has been
     * created.
     * 
     * @param chat
     *            {@link IChat} which has been created
     * @param createdLocally
     *            <code>true</code> if the chat has been created by the local
     *            user, <code>false</code> if the chat has been created by some
     *            remote action
     */
     ...
     * 
     * @param chat
     *            {@link IChat} which has been destroyed
     */
    ...
    /**
     * Notify all {@link IChatServiceListener}s that an {@link IChat} has been
     * aborted through errors in the XMPP/network layer.
     * 
     * @param chat
