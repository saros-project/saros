...
public interface IChat {
     ...
     * 
     * @return the thread id associated with this chat, which corresponds to the
     *         thread field of XMPP messages.
     */
     ...
     * 
     * @param text
     *            the specified text as a message to the other chat participant.
     * @throws XMPPException
     */
     ...
     * 
     * @return <code>true</code> if it is possible to post messages, otherwise
     *         <code>false</code>
     */
