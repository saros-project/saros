...
/**
 * The <code>PreferenceInitializer</code> is responsible for initializing
 * preference values needed for standard operation of the DPP core.
 */
public class PreferenceInitializer {

    /**
     * Initializes the given <code>IPreferenceStore</code> with default
     * preferences values used by the DPP Core.
     * 
     * @param store
     *            the store to initialize
     */
    public static void initialize(IPreferenceStore store) {
        ...
        store.setDefault(PreferenceConstants.USE_NEXT_PORTS_FOR_FILE_TRANSFER,
            true);
        store
            .setDefault(PreferenceConstants.LOCAL_SOCKS5_PROXY_DISABLED, false);
