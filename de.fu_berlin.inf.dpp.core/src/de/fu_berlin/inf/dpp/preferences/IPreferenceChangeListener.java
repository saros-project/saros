 ...
 * <p>
 * The normal usage is an anonymous implementation of this listener
 * 
 * <pre>
...
public interface IPreferenceChangeListener {
    ...
    /**
     * This method is called, when a preference is added or the value has been
     * changed.
     * 
     * @param event
     *            is describing the modified preference with there values
     */
    public void preferenceChange(PreferenceChangeEvent event);
}
