...
public class NoteCompositeDemo extends DescriptiveDemo {
	public NoteCompositeDemo(DemoContainer demoContainer, String title) {
	...
	protected NoteComposite createNoteComposite(Composite parent, int iconId,
		...
		NoteComposite noteComposite = new NoteComposite(parent, SWT.BORDER) {
				...
				button.addSelectionListener(new SelectionAdapter() {
					...
					public void widgetSelected(SelectionEvent e) {
						MessageBox dialog = new MessageBox(parent.getShell(),
								SWT.PRIMARY_MODAL | SWT.OK | SWT.ICON_WORKING);
						dialog.setText("Ouch...");
	...
	public void createContent(Composite parent) {
		...
		for (int i = 0; i < iconIds.length; i++) {
			...
			NoteComposite noteComposite = createNoteComposite(parent,
