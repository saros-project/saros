...
public class ChatControlDemo extends AbstractDemo {
    ...
    public SimpleExplanatoryComposite createSimpleExplanatoryComposite(
        ...
        this.chatControl = new ChatControl(null, new MultiUserChat(null,
            preferences), parent, SWT.BORDER, explanatoryComposite.getDisplay()
    ...
    public void addChatLines() {
        ...
        this.chatControl.addChatLine(new ChatElement(
            "Praesent sed tempor sem. Pellentesque.", new JID(user2), new Date(
                1289066777)));
        ...
        this.chatControl.addChatLine(new ChatElement(
            ...
            new Date(1289466777)));
        this.chatControl.addChatLine(new ChatElement(
            "Vivamus at libero vel purus.", new JID(user1),
            new Date(1289566777)));
        ...
        this.chatControl.addChatLine(new ChatElement(
            ...
            new Date(1289566777)));
        this.chatControl
            .addChatLine(new ChatElement("Lorem ipsum dolor sit amet.",
                new JID(user2), new Date(1289666777)));
        this.chatControl.addChatLine(new ChatElement(
            "Praesent non cursus mauris. Mauris dignissim.", new JID(user2),
            new Date(1289766777)));
        ...
        this.chatControl.addChatLine(new ChatElement(
            "Suspendisse varius lacinia massa vel.", new JID(user2), new Date(
                1298666777)));
    }
}
