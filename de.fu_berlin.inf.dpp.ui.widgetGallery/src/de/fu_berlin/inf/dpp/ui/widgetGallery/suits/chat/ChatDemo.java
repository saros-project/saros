...
public class ChatDemo extends DescriptiveDemo {
	...
	public String getDescription() {
		return "This demo shows a multi user chat using " + NUM_PARTICIPANTS
				+ "x" + NUM_PARTICIPANTS + " " + Chat.class.getSimpleName()
				+ "s.";
	}
	...
	public void createContent(Composite parent) {
		...
		demoControls.setLayoutData(new GridData(SWT.FILL, SWT.FILL, true,
				false, NUM_PARTICIPANTS, 1));
	}
	...
	protected void connect() {
		...
		for (final ChatRoomParticipant chatRoomParticipant : ChatDemo.chatRoomParticipants)
			chatRoomParticipant.createChats(ChatDemo.chatRoomParticipants,
					new MessageListener() {
						public void processMessage(Chat chat,
								final Message message) {

							final String sender = message.getFrom();
							final Color color = ChatRoomParticipant
									.getByUserJID(chatRoomParticipants,
