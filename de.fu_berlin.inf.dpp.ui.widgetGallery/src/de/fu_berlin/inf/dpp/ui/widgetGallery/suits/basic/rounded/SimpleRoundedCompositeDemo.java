...
public class SimpleRoundedCompositeDemo extends Demo {
	public SimpleRoundedCompositeDemo(DemoContainer demoContainer, String title) {
	...
	public void createPartControls(Composite parent) {
		...
		SimpleRoundedComposite c2 = new SimpleRoundedComposite(parent, SWT.NONE);
		c2.setBackground(cl2);
		c2.setTexts(new String[] { "Column 1", "Column 2", "Column 3",
				"Column 4" });
		...
		SimpleRoundedComposite c3 = new SimpleRoundedComposite(parent,
				SWT.SEPARATOR);
		...
		SimpleRoundedComposite c4 = new SimpleRoundedComposite(parent,
				SWT.SEPARATOR);
		c4.setBackground(cl4);
		c4.setTexts(new String[] { "Column 1", "Column 2", "Column 3",
				"Column 4" });
		...
		c5.setTexts(new String[] { "Column 1", "Column 2", "Column 3",
				"Column 4" });
		...
		SimpleRoundedComposite c6 = new SimpleRoundedComposite(parent,
				SWT.SEPARATOR);
		c6.setBackground(cl6);
		c6.setTexts(new String[] { "Column 1", "Column 2", "Column 3",
				"Column 4" });
