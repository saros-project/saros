...
public class IntellijMocker {
     ...
     * <p/>
     * If you use this utility, make sure to (1) run your test class with
     * {@link PowerMockRunner} and (2) add the class to be mocked to the
     * "prepare for test" list:
     * <p/>
     * <pre>
     ...
     * @param argClass class of the argument that is passed to
     *                 <code>getInstance()</code>, if any. Can be <code>null</code>
     */
    public static <T> void mockStaticGetInstance(Class<T> clazz,
        Class<?> argClass) {
        ...
        try {
            if (argClass == null) {
                ...
                clazz.getMethod(method, argClass)
                    .invoke(null, anyObject(argClass));
            }
        } catch (Exception e) {
            e.printStackTrace();
