...
public class SarosCoreTestAction extends AnAction {
    public void actionPerformed(AnActionEvent e) {
        ...
        values += "<b>And a String from the Smack patches:</b> " + StreamError.NAMESPACE;

        values += "</body></html>";

        Project project = e.getData(PlatformDataKeys.PROJECT);

        Messages.showMessageDialog(project, values, "Saros Core Test", Messages.getInformationIcon());
    }
}
