...
public class MUCNegotiationManager {
    ...
    private final ISessionNegotiationHook negotiationHook = new ISessionNegotiationHook() {
        ...
        public void applyActualParameters(Map<String, String> settings) {
            setSessionPreferences(
                new MultiUserChatPreferences(settings.get(KEY_SERVICE),
                    settings.get(KEY_ROOMNAME), settings.get(KEY_PASSWORD)));
        }
    ...
    public MultiUserChatPreferences getOwnPreferences() {
        return new MultiUserChatPreferences(getMUCService(),
            "SAROS" + sessionID.getValue(), password);
    }
    ...
    public void setSessionPreferences(
        MultiUserChatPreferences remotePreferences) {
        log.debug("Got hosts Communication Config: server " + remotePreferences
            .getService() + " room " + remotePreferences.getRoomName() + " pw "
    ...
    private String getMUCService() {
        ...
        if (useCustomMUCService && customMUCService != null && !customMUCService
            .isEmpty()) {
