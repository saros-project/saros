...
public class Filesystem {
    ...
    /**
     * Ensures that the given write action is executed in the correct thread
     * context. This methods waits until the action was executed.
     * <p>
     * If an exception occurs during the execution it is thrown back to the
     * caller, including <i>RuntimeException<i> and <i>Error</i>.
     * 
     ...
     * context. This methods waits until the action was executed.
     * <p>
     * <b>Note:</b> Exceptions are <b>NOT</b> logged. It is up to the caller to
     * log any error during the execution of the <i>runnable</i>.
     * 
     * @see Application#runWriteAction(Runnable)
     */
