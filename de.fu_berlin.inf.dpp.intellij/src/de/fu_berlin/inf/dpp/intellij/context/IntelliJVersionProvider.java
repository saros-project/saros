...
/**
 * Methods in this class can be used to access version information about the
 * running IntelliJ IDEA version and Saros plugin version
 */
public class IntelliJVersionProvider {
    ...
    public static String getPluginVersion() {
        IdeaPluginDescriptor sarosPluginDescriptor = PluginManager
            .getPlugin(PluginId.getId(PLUGIN_ID));

        if (sarosPluginDescriptor == null) {
            throw new IllegalStateException("No plugin with the id \"" +
                PLUGIN_ID + "\" was found");
        }
     ...
     * <p/>
     * <b>NOTE:</b> This is <b>not</b> the version number but the number of the
     * build used for the release.
     *
