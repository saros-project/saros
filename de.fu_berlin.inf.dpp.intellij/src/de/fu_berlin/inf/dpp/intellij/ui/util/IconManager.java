...
public class IconManager {
    ...
    public static ImageIcon getIcon(String path, String description) {
        ...
        if (url == null) {
            LOG.error("Could not load icon " + description
