...
class AnnotationStore<E extends AbstractEditorAnnotation> {
    ...
    void addAnnotation(
        ...
        Map<User, List<E>> annotationsForFile = annotationMap
            .computeIfAbsent(file, givenFile -> new HashMap<>());

        List<E> storedAnnotations = annotationsForFile
            .computeIfAbsent(user, givenFile -> new ArrayList<>());
    ...
    List<E> getAnnotations(
        ...
        if (annotationsForFile != null) {
            annotationsForFile.forEach((user, storedAnnotations) -> {
     ...
     * <p>
     * <b>NOTE:</b> This does not remove the annotations from the local editor.
     * </p>
     *
    ...
    /**
     * Removes all annotations belonging to the given  user from the
     * <code>AnnotationStore</code>.
     * <p>
     * <b>NOTE:</b> This does not remove the annotations from the local editors.
     * </p>
     * <p></p>
     * This method should be used to remove annotations of users who left the
    ...
    List<E> removeAnnotations(
        ...
        annotationMap.forEach((file, annotationsForFile) -> {
            if (annotationsForFile == null) {
                return;
            }
     ...
     * </p>
     * <p></p>
     * This method should be used to remove all annotations after the session
     * has ended.
     *
     * @return the list of removed annotations
     */
