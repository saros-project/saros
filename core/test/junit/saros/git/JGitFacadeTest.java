...
public class JGitFacadeTest {
   ...
   */
  private static void writeCommitToRepo(File workDirTree, int numberOfCommit)
      throws IOException, NoFilepatternException, GitAPIException {
    Git git = Git.open(workDirTree);

    new File(workDirTree, "testfile" + numberOfCommit);

    git.add().addFilepattern(workDirTree.getAbsolutePath()).call(); // git
    // add .
