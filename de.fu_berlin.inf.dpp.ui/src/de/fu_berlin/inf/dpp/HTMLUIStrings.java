...
public class HTMLUIStrings {
    ...
    public static final String ERR_ACCOUNT_SET_ACTIVE_FAILED = "Error while trying to change the active account.";
    public static final String ERR_ACCOUNT_DELETE_ACTIVE = "Couldn't delete the account. The currently active account cannot be deleted";

    public static final String ERR_CONTACT_INVALID_JID = "The Jabber ID must be in the format user@domain.";
    ...
    public static final String ERR_SESSION_PROJECT_LIST_IOEXCEPTION = "An error occurred while trying to create a list of all files to share.";
