...
/**
 * {@link BrowserFunction}s deal with a limited set of parameter and return
 * types. This class refines instances of types {@link Boolean}, {@link Double},
 * and {@link String} (which represent JavaScript <code>boolean</code>,
 * <code>number</code>, and <code>string</code>, respectively).
 * <ul>
 * <li>Booleans will be passed through</li>
 * <li>Doubles will be converted to Integers, Longs, Floats, or Doubles</li>
 * <li>Strings will be passed through, or, if they represent complex objects,
 * deserizalized with {@link Gson}.</li>
 * </ul>
 * For this to work, callers need to provide the expected type, e.g.
 * {@link Integer}, along with the {@link Object} retrieved from the
 * {@link Browser}. Example:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * If the expected type cannot be reproduced with the given input, an
 * {@link IllegalArgumentException} will be thrown.
 * 
 * @see BrowserFunction#function(Object[]) Definition of the JavaScript to Java
 *      type mapping
 */
class TypeRefinery {
    ...
    /**
     * Try to refine the type of the given argument. The following refinements
     * are implemented:
     * <ul>
     * <li><code>null</code> -> <code>null</code></li>
     * <li>Boolean -> Boolean</li>
     * <li>Double -> (Integer|Long|Float|Double)</li>
     * <li>String -> String</li>
     * <li>String -> <i>serializable class</i></li>
     * </ul>
     * For the following argument types there are <b>no</b> refinements
     * implemented yet:
     * <ul>
     * <li>Object[] -> *</li>
     * </ul>
     * 
     * @param argument
     *            An argument coming from the JavaScript world. Can be a
     *            Boolean, a Double, a String, or <code>null</code>
     * @param targetType
     *            The type the argument should be refined to. Can be Boolean,
     *            Double, Float, Long, Integer, String, or any class that can be
     *            deserialized from JSON.
     * @return An object of type targetType, or <code>null</code> if argument
     *         was <code>null</code>
     * 
     * @throws IllegalArgumentException
     *             if the argument cannot be converted to the targetType --
     *             either because there is no refinement implemented, or the
    ...
    public <T> T refine(Object argument, Class<T> targetType) {
        ...
        LOG.warn("Tried to refine argument of unexpected type " + argTypeName
            + " to " + targetTypeName);
        throw new IllegalArgumentException("Cannot refine object of type "
