...
/**
 * This interface couples the IDE-specific locating of resources.
 ...
 */
public interface IWebResourceLocator {

    /**
     * Gets a URL for a given resource.
     *
     * @param resourceName name of the resource, this is the relative path inside
     *                     the resource folder
