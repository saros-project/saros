...
public class ProjectTree {
    ...
    public ProjectTree(Node root) {
        if (root.getType() != Type.PROJECT) {
            throw new IllegalArgumentException(
                "root node needs to be a PROJECT");
        }
    ...
    public static class Node {
        ...
        /**
         * An instance's hash depends on the hashes of its members, will be
         * calculated at the end of its initialization.
         */
        ...
        /**
         * Will create a new {@link Node}. Use
         * {@link #fileNode(String, boolean)} for nodes that represent files.
         * 
         * @param members
         *            A list of members of this node. Can be empty, but must not
         *            be <code>null</code>.
         * @param label
         ...
         *            in a session.
         */
        public Node(List<Node> members, String label, Type type,
            boolean isSelectedForSharing) {
        ...
        public static Node fileNode(String label, boolean isSelectedForSharing) {
            return new Node(new ArrayList<Node>(), label, Type.FILE,
                isSelectedForSharing);
        }
        ...
        /**
         * @return <code>true</code> if this node is selected to be shared in a
         *         session
         */
