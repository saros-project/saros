...
public class RosterFacade {
     ...
     */
    public abstract static class RosterChangeListener implements
        ValueChangeListener<List<Pair<RosterEntry, Presence>>> {
    ...
    private class RosterTrackerListener implements IRosterListener {
        final ObservableValue<List<Pair<RosterEntry, Presence>>> observable = new ObservableValue<List<Pair<RosterEntry, Presence>>>(
            null);
        ...
        private List<Pair<RosterEntry, Presence>> getEntries() {
            ...
            List<Pair<RosterEntry, Presence>> entries = new ArrayList<Pair<RosterEntry, Presence>>(
            ...
            for (RosterEntry entryReference : roster.getEntries()) {
                ...
                entries.add(new Pair<RosterEntry, Presence>(correctEntry,
                    presence));
            }
