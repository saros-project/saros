...
public class JavaScriptAPI {
    ...
    public static void showError(IBrowser browser, String errorMessage) {
        LOG.debug("Trigger js showError() on browser " + browser.getUrl() + ","
            + errorMessage);
     ...
     * 
     */
    public static void updateProjects(IBrowser browser,
        List<ProjectTree> projectTrees) {
        LOG.debug("Sending list of ProjectTree JSONs to browser "
            + browser.getUrl());
     ...
     */
    private static void triggerEvent(IBrowser browser, String javaScriptEvent,
        String parameters) {
