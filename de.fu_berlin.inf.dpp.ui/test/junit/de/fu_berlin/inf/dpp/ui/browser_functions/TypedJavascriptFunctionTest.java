...
public class TypedJavascriptFunctionTest {
    ...
    public void setUp() {
        ...
        JavaScriptAPI.showError(EasyMock.isNull(IBrowser.class),
            EasyMock.isA(String.class));
        PowerMock.expectLastCall().andStubAnswer(new IAnswer<Object>() {
            @Override
    ...
    public void findCallableWhenPresent() {
        Method callable = TypedJavascriptFunction
            .getCallable(SimpleFunctionWithCallable.class);
        assertEquals(callable.getName(), "isGreater");
    }

    @Test(expected = IllegalArgumentException.class)
    public void findCallableWhenAbsent() {
        TypedJavascriptFunction
            .getCallable(SimpleFunctionWithoutCallable.class);
    }
    ...
    public void matchingParameters() {
        ...
        Object resultTrue = func.function(new Object[] { new Double(2),
            new Double(5) });
        assertEquals(Boolean.TRUE, resultTrue);

        Object resultFalse = func.function(new Object[] { new Double(2),
            new Double(1) });
    ...
    public void tooManyParameters() {
        ...
        func.function(new Object[] { new Double(2), new Double(5),
            new Double(1) });
