...
import de.fu_berlin.inf.dpp.xmpp.PacketExtensions;
...
public class Saros extends AbstractUIPlugin {
    ...
    /**
     * @return the SessionManager. Guaranteed to not be null (i.e. the
     * SessionManager is available even if there is currently no connection).
     */
    ...
    /**
     * Adds a new contact to the users roster. This is a blocking method.
     * 
     ...
     * @throws XMPPException throws an XMPPException if this is method is called
    ...
    public void addContact(JID jid, String nickname, String[] groups) throws XMPPException {
        ...
        connection.getRoster().createEntry(jid.getJID(), nickname, groups);
    }
