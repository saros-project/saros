...
import de.fu_berlin.inf.dpp.test.actions.TestJoinWizardAction;
...
public class RosterView extends ViewPart implements IConnectionListener {
    ...
    /**
     * Show user name and state in parenthesis.
     */
    ...
    class NameSorter extends ViewerSorter {
        ...
        public int compare(Viewer viewer, Object e1, Object e2) {
            ...
            // sort by presence // HACK
            if (e1 instanceof RosterEntry) {
                RosterEntry entry1 = (RosterEntry)e1;
                
                if (e2 instanceof RosterEntry) {
                    RosterEntry entry2 = (RosterEntry)e2;
                    
                    boolean presence1 = roster.getPresence(entry1.getUser()) != null;
                    boolean presence2 = roster.getPresence(entry2.getUser()) != null;
    ...
    public void createPartControl(Composite parent) {
        ...
        connectionStateChanged(saros.getConnection(), saros.getConnectionState()); // HACK
    }
    ...
    private void contributeToActionBars() {
        ...
        menuManager.add(new TestJoinWizardAction()); // HACK
