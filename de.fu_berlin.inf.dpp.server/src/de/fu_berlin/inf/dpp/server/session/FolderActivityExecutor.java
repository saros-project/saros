 ...
 */
public class FolderActivityExecutor extends AbstractActivityConsumer implements
    Startable {

    private static final Logger LOG = Logger
        .getLogger(FolderActivityExecutor.class);
     ...
     *            the editor manager
     */
    public FolderActivityExecutor(ISarosSession session,
    ...
    private void executeFolderCreation(FolderCreatedActivity activity)
        throws IOException {
    ...
    private void executeFolderRemoval(FolderDeletedActivity activity)
        throws IOException {
