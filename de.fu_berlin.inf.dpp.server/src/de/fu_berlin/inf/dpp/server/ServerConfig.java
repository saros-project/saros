...
class ServerConfig {
    ...
    /**
     * Returns the password that the Saros server should use to authenticate
    ...
    /**
     * Returns the path of the directory to use as the server's workspace. May
     * be <code>null</code>, which means the server should create a temporary
     * workspace directory by itself and delete it on exit.
     * 
     * @return the path of the workspace directory to use, or <code>null</code>
     *         if a temporary directory should be used
     */
