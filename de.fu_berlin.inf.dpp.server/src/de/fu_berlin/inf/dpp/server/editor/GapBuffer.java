...
public class GapBuffer {
    ...
    public String toString() {
        ...
        System.arraycopy(content, gapStart+gapLength, result, gapStart, content.length-gapStart-gapLength);
    ...
    private void moveGap(int newGapStart, int minGapLength) {
        ...
        if (newGapStart < gapStart) {
            ...
            System.arraycopy(content, gapEnd, target, newGapEnd + (gapStart - newGapStart), content.length-gapEnd);
        } else {
            ...
            System.arraycopy(content, gapEnd + (newGapStart - gapStart), target, newGapEnd, target.length-newGapEnd);
        }
