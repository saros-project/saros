...
public class ServerEditorManager implements IEditorManager {
    ...
    @Override
    public void addSharedEditorListener(
        ISharedEditorListener listener) {
        listeners.add(listener);
    }

    @Override
    public void removeSharedEditorListener(
        ISharedEditorListener listener) {
        listeners.remove(listener);
    }

    /**
     * Get an existing or create a new Editor for a given path.
     * May remove the least recently used Editor to free memory.
     *
    ...
    /**
     * Close all editors of files in a specific folder.
     * Helpful if a folder gets deleted.
     *
