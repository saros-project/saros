...
/**
 * Server implementation of the {@link UISynchronizer} interface. As the server
 * has no actual "UI thread", this implementation creates a dedicated thread
 * playing the UI thread's role instead.
 */
...
public class ServerUISynchronizerImpl implements UISynchronizer {
    ...
    public void syncExec(Runnable runnable) {
        ...
        try {
            ...
            LOG.warn("interrupted while waiting for runnable " + runnable
                + " to finish execution");
