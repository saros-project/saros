...
var SarosState = require('./elements/saros-state');
var MainPage = require('./pages/main-page/main-page');
var StartSessionWizard = require('./pages/start-session-wizard/start-session-wizard');
var Accounts = require('./elements/account/models/accounts');
var Contacts = require('./elements/contact/models/contacts');
var ErrorDialog = require('./elements/error-dialog/error-dialog');
var ProjectTrees = require('./elements/project-tree/models/project-trees');
...
require('bootstrap');
require('./elements/bootstrap-contextmenu');
require('jstree');
