...
public abstract class StfTestCase {
  ...
  /** Checks if the test for establishing a session (concurrently) among three users passed */
  ...
  /**
   * Checks if the test for establishing a session (concurrently) between two users passed and if
   * ConcurrentEditingTest passed
   */
  ...
  /**
   * Checks if the test for establishing a session (concurrently) between two users passed and
   * SimpleFollowModeIITest passed
   */
  ...
  /**
   * Checks if the test for establishing a session (concurrently) between two users passed and
   * EditDuringInvitationTest passed
   */
  ...
  /**
   * Checks if the test for establishing a session (concurrently) among three users passed and
   * ConcurrentEditingTest passed
   */
