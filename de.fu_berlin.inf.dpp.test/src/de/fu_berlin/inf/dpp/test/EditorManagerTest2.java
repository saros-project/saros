...
public class EditorManagerTest2 extends TestCase {
    ...
    // expect(sharedProjectMock.getActiveDriverEditor()).andStubReturn(path1);
    // expect(sharedProjectMock.getDriverTextSelection()).andStubReturn(new
    // TextSelection(23, 42));
    // humbleEditorMock.setSelection(editorPartMock1, new TextSelection(23,
    // 42));
    // replayMocks();
    //
    // EditorManager editorManager = createEditorManager();
    ...
    // IActivityListener activityListenerMock =
