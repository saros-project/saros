...
public class EditorManagerTest extends TestCase {
	...
	file2 = ResourceHelper.createFile(project, "bar.java",
		"public class Test{}");
	...
	assertEquals(file1.getProjectRelativePath(), editorManager
		.getActiveDriverEditor());
    }
	...
	assertFalse(file1.getProjectRelativePath().equals(
		editorManager.getActiveDriverEditor()));
    }

    public void testSetDriverEditorOnStartIfActiveEditorAndDriver()
	    throws Exception {
	editorAPI.openEditor(file1);
	...
	assertEquals(file2.getProjectRelativePath(), editorManager
		.getActiveDriverEditor());
    }
