...
public class ConvergenceProblemTest extends JupiterTestCase {
	...
	ClientSynchronizedDocument c3 = new ClientSynchronizedDocument(
		initDocumentState, network, jid_c3);
	ClientSynchronizedDocument c4 = new ClientSynchronizedDocument(
		initDocumentState, network, jid_c4);
	ClientSynchronizedDocument c5 = new ClientSynchronizedDocument(
		initDocumentState, network, jid_c5);
	ServerSynchronizedDocument s1 = new ServerSynchronizedDocument(network,
		jid_server);
