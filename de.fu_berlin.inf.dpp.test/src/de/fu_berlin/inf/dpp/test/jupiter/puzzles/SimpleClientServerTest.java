...
public class SimpleClientServerTest extends JupiterTestCase {
    ...
    /**
     * Site A insert a char into the delete area of site b. The insert operation
     * has delay of two seconds.
     * 
     * @throws Exception
     */
	...
	TestSuite suite = new TestSuite(
		"Test for simple client server test cases.");
	// $JUnit-BEGIN$
	suite.addTest(new SimpleClientServerTest(
		"testInsertStringWithConcurentDelete"));
	suite.addTest(new SimpleClientServerTest("test2WayProtocol"));
	suite.addTest(new SimpleClientServerTest(
		"testDeleteStringWithConcurentInsert"));
