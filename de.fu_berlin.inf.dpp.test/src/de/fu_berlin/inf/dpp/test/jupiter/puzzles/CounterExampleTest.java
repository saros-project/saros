...
public class CounterExampleTest extends JupiterTestCase {
	...
	ClientSynchronizedDocument c1 = new ClientSynchronizedDocument(
		initDocumentState, network, jid_c1);
	ClientSynchronizedDocument c2 = new ClientSynchronizedDocument(
		initDocumentState, network, jid_c2);
	...
	ClientSynchronizedDocument c3 = new ClientSynchronizedDocument(
		initDocumentState, network, jid_c3);
	ServerSynchronizedDocument s1 = new ServerSynchronizedDocument(network,
		jid_server);
	...
	// $JUnit-BEGIN$
	// suite.addTest(new
	// CounterExampleTest("testCounterExampleViolatingConditionC1"));
	suite.addTest(new CounterExampleTest(
		"testCounterExampleViolatingConditionC2"));
	// suite.addTest(new
	// CounterExampleTest("testCounterExample2ViolatingConditionC2"));
	// $JUnit-END$
	return suite;
    }
}
