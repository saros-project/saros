 ...
 * saros.ui.browser_functions.BrowserFunction} annotation.
 *
 ...
 * return values (e.g. {@link saros.ui.browser_functions.GetValidJID}. Function of the "command"
 * type, i.e. which do change the state of Saros should rely on an event mechanism to trigger
 * changes in the GUI instead of doing this directly (e.g. {@link
 * saros.ui.browser_functions.SetActiveAccount}).
 */
