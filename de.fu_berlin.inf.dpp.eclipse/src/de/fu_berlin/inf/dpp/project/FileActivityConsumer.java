...
public class FileActivityConsumer extends AbstractActivityConsumer implements
    ...
    public FileActivityConsumer(final ISarosSession session,
    ...
    public void exec(IActivity activity) {
        ...
        try {
            if (LOG.isTraceEnabled())
                LOG.trace("executing file activity: " + activity);
    ...
    private void handleFileMove(FileActivity activity) throws CoreException {
        ...
        final IFile fileDestination = toEclipseIFile(activity.getPath()
            .getFile());
     ...
     */
    private static void updateFileEncoding(final String encoding,
        final IFile file) throws CoreException {
    ...
    private static IFile toEclipseIFile(
        de.fu_berlin.inf.dpp.filesystem.IFile file) {
