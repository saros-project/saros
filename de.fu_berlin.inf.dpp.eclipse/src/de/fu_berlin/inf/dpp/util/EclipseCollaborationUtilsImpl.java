...
/**
 * This delegates the {@link ICollaborationUtils} methods the actual eclipse
 * implementation.
 */
...
public class EclipseCollaborationUtilsImpl implements ICollaborationUtils {
    ...
    public void startSession(List<IResource> resources, List<JID> contacts) {
        CollaborationUtils.startSession(
            ResourceAdapterFactory.convertBack(resources), contacts);
    }
    ...
    public void addResourcesToSession(List<IResource> resources) {
        CollaborationUtils.addResourcesToSession(ResourceAdapterFactory
            .convertBack(resources));
    }
