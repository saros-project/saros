...
/**
 * This composite guarantees that its client area does not fall below the
 * specified size.
 * 
 * <dl>
 * <dt><b>Styles:</b></dt>
...
public class MinSizeComposite extends Composite {
    ...
    public Rectangle getClientArea() {
         ...
         * Check minimum size
         */
        if (clientArea.width < minWidth)
            clientArea.width = minWidth;
        if (clientArea.height < minHeight)
            clientArea.height = minHeight;
    ...
    /**
     * Hint for {@link #computeTrim(int, int, int, int)} whether to compute the
     * trim.
     * 
     * @return
     */
    ...
    /**
     * Sets the flag whether {@link #computeTrim(int, int, int, int)} should
     * compute the trim.
     * <p>
     * The flag only works if taken into account by
     * {@link #computeSizeTrimless(int, int)}.
     * 
    ...
    /**
     * In contrast to {@link #computeSize(int, int)} the computed size does not
     * contain the trim.
     * 
     * @param wHint
     * @param hHint
     * @return
     */
    synchronized public Point computeSizeTrimless(int wHint, int hHint) {
