...
public class ConfigurationWizardDialog extends WizardDialog {
    ...
    protected void createButtonsForButtonBar(Composite parent) {
         ...
         * source code
         */
        createAccountButton = createButton(parent, IDialogConstants.CLIENT_ID,
    ...
    protected void firePageChanging(PageChangingEvent event) {
        createAccountButton.setVisible((!accountCreated)
            && event.getTargetPage() instanceof EnterXMPPAccountWizardPage);
    ...
    private void openCreateXMPPAccountWizard() {
        ...
        if (!(page instanceof EnterXMPPAccountWizardPage))
            return;
        ...
        if (createXMPPAccountWizard != null
            ...
            ((EnterXMPPAccountWizardPage) page).setAccount(
                createXMPPAccountWizard.getCreatedXMPPAccount(), true);
        }
